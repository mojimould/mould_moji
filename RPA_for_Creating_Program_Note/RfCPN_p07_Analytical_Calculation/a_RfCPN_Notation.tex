...
%% captionof %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{multicollongtblr}{\EndFaceChamfer}{cX[l]c}
記号 & 内容 & 図面\\
$c_\mathrm{To}$ & \TopEndFaceOutChamferLength & ○\\
$c_\mathrm{Ti}$ & \TopEndFaceInChamferLength & ○\\
$c_\mathrm{Bo}$ & \BottomEndFaceOutChamferLength & ○\\
$c_\mathrm{Bi}$ & \BottomEndFaceInChamferLength & ○\\
...
%% captionof %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{multicollongtblr}{\EndFaceRoundChamfer}{cX[l]c}
記号 & 内容 & 図面\\
$r_\mathrm{To}$ & \TopEndFaceOutRoundChamferRadius & ○\\
$r_\mathrm{Ti}$ & \TopEndFaceInRoundChamferRadius & ○\\
$r_\mathrm{Bo}$ & \BottomEndFaceOutRoundChamferRadius & ○\\
$r_\mathrm{Bi}$ & \BottomFaceInRoundChamferRadius & ○\\
\end{multicollongtblr}
...
記号 & 内容 & 図面\\
$\phi_\mathrm D$ & 端面削加工用フェイスミル刃径（直径） & ○\\
$\phi_\mathrm D'$ & 端面削加工用フェイスミル最大刃径（直径） & ○\\
