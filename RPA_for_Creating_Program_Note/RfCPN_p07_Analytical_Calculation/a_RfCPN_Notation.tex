...
記号 & 内容 & 図面\\
$c_\mathrm{To}$ & トップ端面外C面取長 & ○\\
$c_\mathrm{Ti}$ & トップ端面内C面取長 & ○\\
$c_\mathrm{Bo}$ & ボトム端面外C面取長 & ○\\
$c_\mathrm{Bi}$ & ボトム端面内C面取長 & ○\\
...
記号 & 内容 & 図面\\
$r_\mathrm{To}$ & トップ端面外R面取長 & ○\\
$r_\mathrm{Ti}$ & トップ端面内R面取長 & ○\\
$r_\mathrm{Bo}$ & ボトム端面外R面取長 & ○\\
$r_\mathrm{Bi}$ & ボトム端面内R面取長 & ○\\
\end{multicollongtblr}
