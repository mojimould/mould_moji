...
ここでは主に\Dimple に関する測定・加工に必要な\expandafterindex{きかがくてきせいしつ（\yomiDimple）@幾何学的性質（\nameDimple）}幾何学的性質を考える。
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
よって、テーブル中心Pを原点とした場合における、\expandafterindex{\yomiDimple1れつめ@\Dimple1列目}\Dimple1列目中央の（だいたいの）位置
%% footnote %%%%%%%%%%%%%%%%%%%%%
