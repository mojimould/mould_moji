...
ここでは主に、\textbf{\KeywayWidth}に関する測定・加工に必要な\expandafterindex{きかがくてきせいしつ（\yomiKeyway）@幾何学的性質（\nameKeyway）}幾何学的性質を考える。
...
\item \KeywayCenter Mが、モールドの\index{わんきょくちゅうしんせん@湾曲中心線}湾曲中心線上にある場合
