...
\modHeadchapter[loC,lof]{全長および振分けの幾何\label{chap:ACfuriwake}\vphantom{\ref{chap:ACfuriwake}}}
...
基本的な考え方として、\textbf{\CenterCurvature}$R_\mathrm c$の円の中心を原点として$\Omega$だけ回転し、次にワークとの（スペーサを装着していない側の）接点を中心に$-\theta$だけ回転したと考えることができる。
...
%% Column %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{Column}{\CenterCurvature 無限大の極限\TBW}
(to be written...)
\end{Column}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
