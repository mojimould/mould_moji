...
\ttNum432\TBW & トップ外面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum433\TBW & トップ外面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum434 & （不使用）\\\hline
\ttNum435\TBW & トップ内面取$X+$補正 & 0\\\hline
\ttNum436\TBW & トップ内面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum437\TBW & トップ内面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum438 & （不使用）\\\hline
\ttNum439\TBW & ボトム外面取$X+$補正 & 0\\\hline
\ttNum440\TBW & ボトム外面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum441\TBW & ボトム外面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum442 & （不使用）\\\hline
\ttNum443\TBW & ボトム内面取$X+$補正 & 0\\\hline
\ttNum444\TBW & ボトム内面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
