...
%% section 15.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{コモン変数 (\ttNum100\,-\ttNum174)}
...
%% common variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{table}{\ttNum100\,-\ttNum110：主に一時保存値}
\begin{twoCtable}{}
\ttNum100 & 各工程 切削回数用 一時保存値（全削り代$X$）\\\hline
\ttNum101 & 各工程 切削回数用 一時保存値（全削り代$Y$）\\\hline
\ttNum102 & 各工程 切削回数用 一時保存値 (max[\ttNum100, \ttNum101])\\\hline
\ttNum103 & 各工程 切削回数用 一時保存値（切削回数）\\\hline
...
%% section 15.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{コモン変数 (\ttNum175\,-\ttNum199)}
...
\ttNum429\TBW & 溝 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum430 & （不使用）
\end{twoCtable}
