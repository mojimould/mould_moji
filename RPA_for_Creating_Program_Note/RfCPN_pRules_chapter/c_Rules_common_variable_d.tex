...
\begin{twoCtable}{}
\ttNum100 & 各工程 切削回数用 一時保存値（全削り代$X$ or $Z$）\\\hline
...
%% section 15.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{コモン変数 (\ttNum400\,-\ttNum474)\TBW}
\addtocontents{lot}{\protect\addvspace{3pt}}{}{}
\addcontentsline{lot}{section}{\numberline{\thesection}\Sectionname}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% common variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\clearpage
\modcaptionof{table}{\ttNum413\,-\ttNum430：主に加工用（内面溝除く）}
\begin{twoCtable}{}
...
\ttNum428 & 溝 仕上げ前 一時停止 (0:non-stop, 1:溝径\ttNum655残し\verb|M00|) & 0\\\hline
\ttNum429 & 溝 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum430 & （不使用）
\end{twoCtable}
...
\ttNum654\TBW & 溝加工1回あたりの径方向削り代（片面深さ） & 5.0\\\hline
