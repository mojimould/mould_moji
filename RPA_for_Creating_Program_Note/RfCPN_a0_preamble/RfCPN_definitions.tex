...
%%%%% FOR PART WITH TABLE %%%%%%%%%%%%%%%%%%
%\newcommand*{\globaladdcontentsline}[3]{\addtocontents{#1}{\protect\contentsline{#2}{#3}{\thepage}}}
\newcommand{\tPart}[4][]{%
  \def\temppartnum{\the\numexpr\value{part}+1}%
...
%    row{Z} = {gray!15,white},
%    rowhead = 1,
%    abovesep = 3pt, % corresponds to \LTpre
%    belowsep = 5pt, % corresponds to \LTpost
%    lmargin = 0pt, % corresponds to \LTleft
%    rmargin = \fill, % corresponds to \LTright
%  ]{#1}
%  #2\\
%}
%{%
