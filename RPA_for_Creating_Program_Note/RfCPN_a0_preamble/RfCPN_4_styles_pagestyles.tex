...
\newcommand{\commoncfoot}{\scriptsize
  \hyperref[chap:VI.37]{コモン変数}\quad
  \hyperref[chap:VI.A]{システム変数}\quad
  \hyperref[part:VII]{解析計算}\quad
  \hyperref[chap:IX.I]{Gコード}\quad
  \hyperref[sec:IX.I.2]{Mコード}\quad
  \hyperref[chap:IX.K]{プログラム}%
}
