...
This document was created using \hologo{TeX} (\linkLaTeXe{} and \linkLaTeXthree), specifically utilizing tools such as \linkTeXLive{} 2023, \linkLuaTeX{} (\hologo{LuaLaTeX}), \linkBibLaTeX\ (\linkBiber), \linkupmendex, \linkPGFTikZ, \linkKOMAscript{} and many useful packages, libraries and modules.\\
...
\hfill%
\begin{tabular}{rl}
\hologo{TeX}{} and \linkLaTeX & are trademarks of \linkAMS.\\
