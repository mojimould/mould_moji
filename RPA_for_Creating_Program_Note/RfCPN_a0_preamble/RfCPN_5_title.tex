...
\item
The document was typeset using the \linkEuler, \linkAMSFonts, \linkLatinModern, \linkHaranoAji, \linkArvo, \linkRoboto, \linkSourceSansPro, \linkTrajanPro, \linkURWArial, \linkURWClassico, \linkSegoeUI, \linkTestSohne, and \linkHuiFont{} font families.
\item
