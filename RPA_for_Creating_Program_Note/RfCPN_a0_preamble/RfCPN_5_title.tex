...
This document was created using \hologo{TeX} (\linkLaTeXe{} and \linkLaTeXthree), specifically utilizing tools such as \linkTeXLive{} 2024, \linkLuaTeX{} (\linkLuaTeXja, \hologo{LuaLaTeX}), \linkKOMAScript{}, \linkBibLaTeX{} (\linkBiber), \linkUpmendex, \linkPGFTikZ, and many useful packages, libraries and modules.\\
