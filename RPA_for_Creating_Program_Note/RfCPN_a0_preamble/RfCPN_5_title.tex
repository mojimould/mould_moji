...
{\footnotesize%
(Among these tools, this was my first time using \linkTeXLiveYear, \linkLuaTeX, \linkLaTeXthree, \linkScrlayerscrpage, \linkTeXstudio, \linkSumatraPDF, \linkBibTeX, \linkUpmendex, \linkMendexDoc, \nameGcodeProgram{} (\nameNCProgram), \nameArumatikMi, \linkNcgcode, \linkGit, \linkGitHub, and \linkMicrosoftCopilot)%
}%
}
