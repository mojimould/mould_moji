...
This document was created using \hologo{TeX} (\linkLaTeXe{} and \linkLaTeXthree), specifically utilizing tools such as \linkTeXLive{} 2024, \linkLuaTeX{} (\hologo{LuaLaTeX}, \linkLuaTeXja), \linkKOMAScript{}, \linkBibLaTeX{} (\linkBiber), \linkUpmendex, \linkPGFTikZ, and many useful packages, libraries and modules.\\
...
\phantom{T}Thanks to these tools, with the all-around support of \linkChatGPT-4 (\linkMicrosoftCopilot), the creation of the document and system was created possible, even while navigating solo and finding my way in the quiet corners.%
}
