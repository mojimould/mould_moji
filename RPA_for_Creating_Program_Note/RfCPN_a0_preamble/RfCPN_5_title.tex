...
\date{}
\author{\ \\{\small Author:} \fontspec[Path=./RfCPN_a1_fonts/]{HuiFontP29}Kurahashi Nobuaki}
...
\begin{enumerate}[label={-}, leftmargin=8pt]
\item
This document was created using \nameTeX{} (\linkLaTeXe, \linkLaTeXthree), specifically utilizing tools such as \linkTeXLiveYear, \linkLuaTeX{} (\linkLuaLaTeX, \linkLuaTeXja, \linkLua), \linkKOMAScript{} (\linkScrbook, \linkScrlayerscrpage) and \linkPGFTikZ, and many useful packages, libraries and modules.
\item
...
\item
The document was typeset using the \linkEuler, \linkAMSFonts, \linkLatinModern, \linkHaranoAji, \linkArvo, \linkRoboto, \linkSourceSansPro, \linkURWArial, \linkURWClassico, \linkSegoeUI, \linkTestSohne, and \linkHuiFont{} font families.
\item
...
\end{enumerate}
Thanks to these tools, with the all-around support of \linkChatGPT-4 (\linkMicrosoftCopilot), the creation of the documents and system was made possible.
...
{\small%
(Among these tools, software, and languages, this was my first time using \linkTeXLiveYear, \linkLuaTeX, \linkLaTeXthree, \linkScrlayerscrpage, \linkTeXstudio, \linkSumatraPDF, \linkBibTeX, \linkUpmendex, \linkMendexDoc, \nameGcodeProgram{} (\nameNCProgram), \nameArumatikMi, \linkNcgcode, \linkGit, \linkGitHub, and \linkMicrosoftCopilot)%
}
}
...
\hfill%
\begin{tabular}{rl}
\hologo{TeX}, \linkLaTeX{} and \linkAMSFonts & are trademarks of \linkAMS.\\
...
\hrulefill\\
Copyright © 2023, 2024.\\
These documents and these systems are owned by the individual writer (the author of this documnet), not any corporation. All rights reserved.
\end{spacing}
