...
This document was created using \hologo{TeX} (\linkLaTeXe{} and \linkLaTeXthree), specifically utilizing tools such as \linkTeXLive{} 2023, \linkLuaTeX{} (\hologo{LuaLaTeX}), \BibLaTeX{} (\hologo{biber}), upmendex, \linkPGFTikZ, \linkKOMAScript{} and many useful packages, libraries and modules.\\
