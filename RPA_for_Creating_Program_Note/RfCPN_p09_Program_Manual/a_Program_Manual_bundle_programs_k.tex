...
\modHeadchapter[lot]{バンドルのNCプログラム}
ここでは機械設置時付属の\index{NCプログラム}NCプログラムについて記載する。
これらの\index{NCプログラム}プログラムは、当社の\index{しょくむちょさくぶつ@職務著作物}職務著作物ではないため、\pageautoref{subsec:standardscopyrightsSubcontractor}に則り、その詳細の記載は割愛する。
