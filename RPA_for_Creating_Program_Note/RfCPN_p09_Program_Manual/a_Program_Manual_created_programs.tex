...
\begin{multicollongtblr}{作成したプログラム一覧：メインプログラムの例}{ccX[l]}
...
\MainExOne & 外側芯出し・幅 & \MYOThickness\MXIface\\
           ...
           & 端面外C面取 & \KSotoMentoriRLeft\\
           & 端面内C面取 & \KUchiMentoriRLeft\\
...
\KSotoMentoriRLeft & 加工 端面外C面取 コーナーR 左回り1周 & \KOLeftAR\OpauseCheck\\
\KUchiMentoriRLeft & 加工 端面内C面取 コーナーR 左回り1周 & \KILeftAC\OpauseCheck\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KSotoMentoriRLeft\,:加工 端面外C面取 コーナーR 左回り1周}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KUchiMentoriRLeft\,:加工 端面内C面取 コーナーR 左回り1周}
