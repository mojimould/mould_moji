...
\SetRow{unusingVariables}
\ttNum700 & （予備）\\
\ttNum701 & プログラム読込時のワーク座標系(\ttNum4012)\\
\ttNum702 & 工具別$Z$補正({\ttfamily T50}:\ttNum901050, {\ttfamily T3x}:0)\\
\ttNum703 & 工具別$XY$補正({\ttfamily T50}:\ttNum901050, {\ttfamily T3x}:\ttNum[2400+\ttNum4111]+\ttNum[2600+\ttNum4111])\\
\ttNum704 & 工具別{\ttfamily G\ttNum} ({\ttfamily T50}:31, {\ttfamily T3x}:01)\\
...
\ttNum708 & テーブル中心から\dimple1列目までの$Z$距離$Z-q$\\
\ttNum709 & トップ端中心から\dimple1列目中心までの$X$距離(\cf\pageeqref{eq:dimpleCenterDistance})\\
\ttNum710 & 傾き後\dimple1列目中心$X$移動距離(\cf\pageeqref{eq:afterPhidimpleCenterDistance})\\
\ttNum711 & 傾き後\dimple1列目中心$Z$移動距離(\cf\pageeqref{eq:afterPhidimpleCenterDistance})\\
\ttNum712 & 傾き後トップ端中心（ブロックエンド）$X$座標(\ttNum5001)\\
\ttNum713 & 傾き後トップ端中心（ブロックエンド）$Z$座標(\ttNum5003)\\
...
\ttNum718 & BD内半径$+$めっき膜厚$-\text{\ttNum703}-\text{\ttNum620}$\\
\ttNum719 & (AC内半径$+$めっき膜厚$-\text{\ttNum703}-\text{\ttNum620}\text)\cos\phi$\\
\SetRow{unusingVariables}
\ttNum720 & （予備）\\
\SetRow{unusingVariables}
\ttNum721 & （予備）\\
