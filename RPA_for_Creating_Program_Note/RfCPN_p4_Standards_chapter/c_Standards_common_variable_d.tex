...
\begin{multicollongtblr}[white]{\ttNum901100\,-\ttNum901124：工具}{cX[l]c}
変数 & 内容 & 初期値\\
\SetRow{unusingVariables}
\ttNum901100 & （予備） &\\
...
\begin{multicollongtblr}[white]{\ttNum901124\,-\ttNum901149：工具（続き）}{cX[l]c}
変数 & 内容 & 初期値\\
\SetRow{unusingVariables}
...
\SetRow{unusingVariables}
\ttNum901147 & （予備） &\\
\ttNum901148 & 工具{\ttfamily T50}（タッチセンサープローブ）先端球 半径 & 5.0\\
\ttNum901149 & 工具{\ttfamily T50}（タッチセンサープローブ）軸部分 半径 & 3.75\\
\end{multicollongtblr}
