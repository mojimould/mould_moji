...
\begin{align}
  ...
  &= -\varDelta+\sqrt{R_\mathrm c^2-f_\mathrm T^2}+\frac{\delta_s}2
     -\sqrt{R_\mathrm i'^2-\frac{\delta_s^2+(2\bar l)^2}4}
      \frac{2\bar l}{\sqrt{\delta_s^2+\left(2\bar l\right)^2}}
     \label{eq:spacerTRc}
\end{align}
で与えられる
%% footnote %%%%%%%%%%%%%%%%%%%%%
...
\begin{align*}
  \text{C側端点：}&
  -\varDelta+\sqrt{R_\mathrm i^2-f_\mathrm T^2}+\frac{\delta_s}2
  -\sqrt{R_\mathrm i'^2-\frac{\delta_s^2+(2\bar l)^2}4}\frac{2\bar l}{\sqrt{\delta_s^2+(2\bar l)^2}}\ ,\\
  \text{A側端点：}&
  -\varDelta+\sqrt{R_\mathrm o^2-f_\mathrm T^2}+\frac{\delta_s}2
  -\sqrt{R_\mathrm i'^2-\frac{\delta_s^2+(2\bar l)^2}4}\frac{2\bar l}{\sqrt{\delta_s^2+(2\bar l)^2}}\ .
\end{align*}
...
\begin{align*}
%  \label{eq:spacerBRc}
  \varDelta-\sqrt{R_\mathrm c^2-f_\mathrm B^2}-\frac{\delta_s}2
  +\sqrt{R_\mathrm i'^2-\frac{\delta_s^2+(2\bar l)^2}4}\frac{2\bar l}{\sqrt{\delta_s^2+(2\bar l)^2}}\ .
\end{align*}
...
\begin{align*}
  \text{C側端点：}&~~
  \varDelta-\sqrt{R_\mathrm i^2-f_\mathrm B^2}-\frac{\delta_s}2+\sqrt{R_\mathrm i'^2-\frac{\delta_s^2+(2\bar l)^2}4}\frac{2\bar l}{\sqrt{\delta_s^2+(2\bar l)^2}}\ ,\\
  \text{A側端点：}&~~
  \varDelta-\sqrt{R_\mathrm o^2-f_\mathrm B^2}-\frac{\delta_s}2+\sqrt{R_\mathrm i'^2-\frac{\delta_s^2+(2\bar l)^2}4}\frac{2\bar l}{\sqrt{\delta_s^2+(2\bar l^2}}\ .
\end{align*}
