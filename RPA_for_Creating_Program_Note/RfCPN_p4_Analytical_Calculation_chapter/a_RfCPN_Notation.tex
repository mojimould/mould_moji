...
ここでは\pageautoref{part:V}で用いた変数等の表記を一覧にしてまとめておく。
...
%% captionof %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{3columnstable}{溝}{|Sc|Sl|Sc|}{記号}{内容\hspace*{0.72\textwidth}~}{図面}
...
\begin{3columnstable}{ジグ}{|Sc|Sl|Sc|}{記号}{内容\hspace*{0.72\textwidth}~}{図面}
$l$ & ジグ長さの半分 & ○\\\hline
$\rho$ & 受板の半径 & ○\\\hline
$\sigma$ & 受板の幅 & ○\\\hline
...
\clearpage
\begin{3columnstable}{eテーパ}{|Sc|Sl|Sc|}{記号}{内容\hspace*{0.72\textwidth}~}{参照}
$T_\mathrm l$ & 液相線温度 &\\\hline
$T_\mathrm s$ & 固相線温度 &\\\hline
$T_0$ & 基準温度 &\\\hline
$X_\mathrm C$ & 炭素Cの含有量 &\\\hline
$X_\mathrm{Si}$ & ケイ素Siの含有量 &\\\hline
$X_\mathrm{Mn}$ & マンガンMnの含有量 &\\\hline
$X_\mathrm P$ & リンPの含有量 &\\\hline
$X_\mathrm S$ & 硫黄Sの含有量 &\\\hline
$k_\mathrm C$ & 炭素Cにおける影響係数 &\\\hline
$k_\mathrm{Si}$ & ケイ素Siにおける影響係数 &\\\hline
$k_\mathrm{Mn}$ & マンガンMnにおける影響係数 &\\\hline
$k_\mathrm P$ & リンPにおける影響係数 &\\\hline
$k_\mathrm S$ & 硫黄Sにおける影響係数 &\\
\end{3columnstable}


%\clearpage
\begin{3columnstable}{アイソパラメトリック曲線}{|Sc|Sl|Sc|}{記号}{内容\hspace*{0.72\textwidth}~}{図面}
$S(u, v)$ & パラメトリックサーフェス &\\\hline
$u, v$ & パラメトリックサーフェスのパラメータ &\\\hline
$C(t)$ & アイソパラメトリック曲線 &\\\hline
$f_i$ & アイソパラメトリック曲線の基底関数 &\\\hline
$P_i$ & アイソパラメトリック曲線の制御点 &\\\hline
$N_{i, p}$ & B-スプライン曲線の基底関数 &\\\hline
$U$ & ノットベクトル &\\\hline
$u_i$ & ノットベクトルの成分 &\\\hline
$p$ & 基底関数$N_{i, p}$の次数 &\\\hline
