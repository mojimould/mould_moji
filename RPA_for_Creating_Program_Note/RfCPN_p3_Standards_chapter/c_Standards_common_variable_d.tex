...
\begin{2columnstable}{\ttNum100\,-\ttNum110：一時保存値}{|Sc|Sl|}{番号}{内容}
...
\begin{3columnstable}{\ttNum175\,-\ttNum199：各工程後一時停止}{|Sc|Sl|Sc|}{番号}{内容}{初期値}
\rowcolor{unusingVariables}
\ttNum175 & （以下 予備） &\\\hline
\rowcolor{unusingVariables}
...
\begin{3columnstable}{\ttNum400\,-\ttNum404：初期設定}{|Sc|Sl|Sc|}{番号}{内容}{初期値}
...
\begin{3columnstable}{\ttNum405\,-\ttNum414：測定時の調整（\dimple 除く）}{|Sc|Sl|Sc|}{番号}{内容}{初期値}
...
\clearpage
\begin{3columnstable}{\ttNum415\,-\ttNum424：加工時の調整（端面・\dimple 除く）}{|Sc|Sl|Sc|}{番号}{内容}{初期値}
...
\begin{3columnstable}{\ttNum425\,-\ttNum449：加工時の調整（続き）}{|Sc|Sl|Sc|}{番号}{内容}{初期値}
...
\begin{3columnstable}{\ttNum450\,-\ttNum474：\dimple 深さの調整}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
...
\ttNum500\,-\ttNum599については、\index{バンドルのプログラム}バンドルのプログラム\myprg{O910x}\myprg{O93xx}で使用されており、作成したプログラムには用いていない。
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% marker %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{marker}
...
\begin{3columnstable}{\ttNum500\,-\ttNum524：\myprg{O910x}\myprg{O93xx}用}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
\ttNum500 & 芯ずれ許容差 \myprg{O93xx} & 5.000\\\hline
\ttNum501 & タッチセンサー信号遅れ補正 \myprg{O93xx} & 0.040\\\hline
\ttNum502 & タッチセンサープローブ中心$X$補正 \myprg{O93xx} & -0.016507\\\hline
\ttNum503 & タッチセンサープローブ中心$Y$補正 \myprg{O93xx} & -0.068371\\\hline
\ttNum504 & 測定距離 \myprg{O910x} & 5.000\\\hline
\ttNum505 & プローブ表面からプログラムの加工原点($Z$0)までの距離 \myprg{O910x} & 785.529\\\hline
\ttNum506 & 工具長の変化の許容差 \myprg{O910x} & 1.000\\\hline
\ttNum507 & 工具破損検出の許容差 \myprg{O910x} & 1.000\\\hline
\ttNum508 & （不明） & \ttNum0\\\hline
\ttNum509 & Z座標系設定 \myprg{O93xx} & 441.432\\\hline
\ttNum510 & （不明） & 270.000\\\hline
\ttNum511 & インチ／ミリ切替 \myprg{O910x} & \ttNum0\\\hline
\ttNum512 & タッチセンサープローブ半径$\mathrm{mm}$値 \myprg{O93xx} & 5.000\\\hline
\ttNum513 & 移動時用の送り速さ値 \myprg{O910x} & 1000.000\\\hline
\ttNum514 & スキップ(\verb|G31|)測定時用 送り速さ値 \myprg{O910x}\myprg{O93xx} & 50.000\\\hline
\ttNum515 & （不明） & \ttNum0\\\hline
\ttNum516 & センサーの位置$X$座標 \myprg{O910x} & -30.374\\\hline
\ttNum517 & センサーの位置$Y$座標 \myprg{O910x} & -913.761\\\hline
\ttNum518 & センサーの位置$Z$座標 \myprg{O910x} & -785.529\\\hline
\ttNum519 & （不明） & 6.000\\\hline
\ttNum520 & 拡張ワーク座標系 \myprg{O910x} & 1861.000\\\hline
\ttNum521 & （不明） & 0.000\\\hline
\ttNum522 & （不明） & 0.000\\\hline
\ttNum523 & アプローチ時用の送り速さ値 \myprg{O910x} & 30.000\\\hline
\ttNum524 & 測定時用の送り速さ値 \myprg{O910x} & 3.000\\\hline
...
\begin{3columnstable}{\ttNum600\,-\ttNum624：ワークと工具間の距離の調整}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
\rowcolor{unusingVariables}
\ttNum600 & （予備） &\\\hline
...
\begin{3columnstable}{\ttNum650\,-\ttNum674：残り代および1回あたりの削り代}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
...
\begin{3columnstable}{\ttNum675\,-\ttNum699：工具の送り速さ}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
...
\ttNum700\,-\ttNum750については、主に\expandafterindex{\dimplekana そくていようサブプログラム@\dimple 測定用サブプログラム}\dimple 用サブプログラム\myprg{O2x000x}で使用されるものとする。
...
\begin{2columnstable}{\ttNum700\,-\ttNum724：\dimple~レベル1サブプログラム用 \DLone}{|Sc|Sl|}{番号}{内容}
\rowcolor{unusingVariables}
\ttNum700 & （予備）\\\hline
...
\begin{2columnstable}{\ttNum725\,-\ttNum744：\dimple~レベル2サブプログラム用 \DLtwoAC\DLtwoBD}{|Sc|Sl|}{番号}{内容}
...
%\clearpage
\begin{2columnstable}{\ttNum745\,-\ttNum749：\dimple~測定用 \DMLthreeAC\DMLthreeBD}{|Sc|Sl|}{番号}{内容}
\rowcolor{unusingVariables}
\ttNum745 & （以下 予備）\\\hline
\rowcolor{unusingVariables}
$\cdots$ & \qquad$\cdots$\\\hline
...
\begin{2columnstable}{\ttNum900001\,-\ttNum900005：外中心$X$ 両側測定用 \MXOThickness}{|Sc|Sl|}{番号}{内容}
...
\begin{2columnstable}{\ttNum900006\,-\ttNum900010：外中心$Y$ 両側測定用 \MYOThickness}{|Sc|Sl|}{番号}{内容}
...
%\clearpage
\begin{2columnstable}{\ttNum900011\,-\ttNum900013：溝中心$X$ 片側測定用 \MXOface}{|Sc|Sl|}{番号}{内容}
...
%\clearpage
\begin{2columnstable}{\ttNum900014\,-\ttNum900018：内中心$X$ 両側測定用 \MXIWidth}{|Sc|Sl|}{番号}{内容}
...
\clearpage
\begin{2columnstable}{\ttNum900019\,-\ttNum900023：内中心$Y$ 両側測定用 \MYIWidth}{|Sc|Sl|}{番号}{内容}
...
%\clearpage
\begin{2columnstable}{\ttNum900024\,-\ttNum900026：外削中心$X$ 片側測定用 \MXIface}{|Sc|Sl|}{番号}{内容}
...
%\clearpage
\begin{2columnstable}{\ttNum900027\,-\ttNum900030：通り芯$Y$ 片側測定用 \MYcenterline}{|Sc|Sl|}{番号}{内容}
...
\begin{2columnstable}{\ttNum900031\,-\ttNum900034：通り芯$X$ 片側測定用 \MXcenterline}{|Sc|Sl|}{番号}{内容}
...
\begin{2columnstable}{\ttNum900101\,-\ttNum900300：\dimple AC表面位置 測定値 \DMLthreeAC}{|Sc|Sl|}{番号}{内容}
...
\begin{2columnstable}{\ttNum900301\,-\ttNum900500：\dimple BD表面位置 測定値 \DMLthreeBD}{|Sc|Sl|}{番号}{内容}
...
\begin{3columnstable}{\ttNum901000\,-\ttNum901024：主にパレット・ジグ}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
\rowcolor{unusingVariables}
\ttNum901000 & （予備） &\\\hline
...
\begin{3columnstable}{\ttNum901100\,-\ttNum901124：工具}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
\rowcolor{unusingVariables}
\ttNum901100 & （予備） &\\\hline
...
%\clearpage
\begin{3columnstable}{\ttNum901125\,-\ttNum901149：工具（続き）}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
\rowcolor{unusingVariables}
