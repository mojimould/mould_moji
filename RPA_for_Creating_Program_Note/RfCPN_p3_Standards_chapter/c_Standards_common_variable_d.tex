...
\clearpage
\begin{multicollongtblr}[white]{\ttNum414\,-\ttNum424：加工時の調整（端面・\dimple 除く）\TBW}{cX[l]c}
変数 & 内容 & 初期値\\
\ttNum414 & トップ外削 A面肉厚$+$補正（外削中心$X-$補正） & 0\\
\SetRow{unusingVariables}
\ttNum415\TBW & （トップ外削径補正用 予備） &\\
