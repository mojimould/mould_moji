...
\begin{3columnstable}[white]{\ttNum450\,-\ttNum474：\dimple の深さ調整}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
...
\begin{3columnstable}[white]{\ttNum500\,-\ttNum574：\prgbox{O910x}\prgbox{O93xx}用}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
...
\begin{3columnstable}[white]{\ttNum650\,-\ttNum674：工具の送り速さ}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
...
\rowcolor{unusingVariables}
\ttNum657 & （不使用） &\\\hline
\ttNum658 & 端面加工：直線 & 900\\\hline
\ttNum659 & 端面加工：コーナー & 900\\\hline
\ttNum660 & 外削加工：直線 & 400\\\hline
\ttNum661 & 外削加工：コーナー & 400\\\hline
\ttNum662 & 溝加工：直線 & 500\\\hline
\ttNum663 & 溝加工：コーナー & 400\\\hline
\ttNum664 & 外面取加工：直線 & 500\\\hline
\ttNum665 & 外面取加工：コーナー & 400\\\hline
\ttNum666 & 内面取加工：直線 & 400\\\hline
\ttNum667 & 内面取加工：コーナー & 400\\\hline
\ttNum668 & 座ぐり加工：直線 & 40\\\hline
\ttNum669 & 座ぐり加工：コーナー & 40\\\hline
\ttNum670 & \dimple 加工：表面アプローチ & 540\\\hline
\ttNum671 & \dimple 加工：加工 & 100\\\hline
\rowcolor{unusingVariables}
$\cdots$ & （以下予備） &
\end{3columnstable}
...
\begin{3columnstable}[white]{\ttNum675\,-\ttNum699：スピンドル回転数（切削時）}{|Sc|Sl|Sc|}{番号}{内容}{設定値}
\ttNum675 & 端面加工 & 950\\\hline
\ttNum676 & 外削加工 & 930\\\hline
\ttNum677 & 溝加工 & 930\\\hline
\ttNum678 & 外面取加工 & 1800\\\hline
\ttNum679 & 内面取加工 & 1800\\\hline
\ttNum680 & 座ぐり加工 & 500\\\hline
\ttNum681 & \dimple 加工 & 2000\\\hline
\rowcolor{unusingVariables}
$\cdots$ & （以下予備） &
\end{3columnstable}
...
\begin{2columnstable}[white]{\ttNum700\,-\ttNum724：\dimple~移動 \DLone 用}{|Sc|Sl|}{番号}{内容}
\rowcolor{unusingVariables}
\ttNum700 & （予備）\\\hline
...
\begin{2columnstable}[white]{\ttNum725\,-\ttNum744：\dimple~移動 \DLtwoAC\DLtwoBD 用}{|Sc|Sl|}{番号}{内容}
...
%\clearpage
\begin{2columnstable}[white]{\ttNum745\,-\ttNum749：\dimple~測定~\DMLthreeAC\DMLthreeBD 用}{|Sc|Sl|}{番号}{内容}
\rowcolor{unusingVariables}
\ttNum745 & （以下 予備）\\\hline
\rowcolor{unusingVariables}
$\cdots$ & \qquad$\cdots$\\\hline
...
\ttNum901006 & パレット\ttNum2 ジグ中心機械座標$Y$ & -739.555\\\hline
