...
\begin{3columnstable}[white]{\ttNum500\,-\ttNum524：\myprg{O910x}\myprg{O93xx}用}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
\ttNum500 & 芯ずれ許容差 \myprg{O93xx} & 5\\\hline
...
\ttNum504 & 測定距離 \myprg{O910x} & 5\\\hline
\ttNum505 & プローブ表面からプログラムの加工原点($Z$0)までの距離 \myprg{O910x} & 785.529\\\hline
\ttNum506 & 工具長の変化の許容差 \myprg{O910x} & 1.0\\\hline
\ttNum507 & 工具破損検出の許容差 \myprg{O910x} & 1.0\\\hline
...
\ttNum512 & タッチセンサープローブ半径$\mathrm{mm}$値 \myprg{O93xx} & 5.0\\\hline
\ttNum513 & 移動時用の送り速さ値 \myprg{O910x} & 1000\\\hline
\ttNum514 & スキップ(\verb|G31|)測定時用 送り速さ値 \myprg{O910x}\myprg{O93xx} & 50\\\hline
...
\ttNum519 & （不明） & 6\\\hline
\ttNum520 & 拡張ワーク座標系 \myprg{O910x} & 1861\\\hline
\ttNum521 & （不明） & 0\\\hline
\ttNum522 & （不明） & 0\\\hline
\ttNum523 & アプローチ時用の送り速さ値 \myprg{O910x} & 30\\\hline
\ttNum524 & 測定時用の送り速さ値 \myprg{O910x} & 3\\\hline
...
\ttNum678 & アプローチ送り速さ値（タッチセンサープローブ） & 1500\\\hline
\ttNum679 & 測定時アプローチ送り速さ値（片側測定） & 50\\\hline
\ttNum680 & 測定時アプローチ送り速さ値（両側測定） & 200\\\hline
\rowcolor{unusingVariables}
\ttNum\TBW & 工具長測定用 送り速さ値 & 1000\\\hline
\rowcolor{unusingVariables}
\ttNum681 & （予備） &\\\hline
...
\begin{3columnstable}[white]{\ttNum901100\,-\ttNum901124：工具}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
\rowcolor{unusingVariables}
\ttNum901100 & （予備） &\\\hline
...
%\clearpage
\begin{3columnstable}[white]{\ttNum901125\,-\ttNum901149：工具（続き）}{|Sc|Sl|Sc|}{番号}{内容\hspace*{0.71\textwidth}}{設定値}
\rowcolor{unusingVariables}
