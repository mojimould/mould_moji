...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{marker}
\index{がいさくちゅうしん@外削中心}外削中心測定\MXIface で内面取がある場合、測定位置$Z$は端面$Z$位置でないことに注意
\end{marker}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ttNum675\,-\ttNum699については、工具の\index{スピンドル}スピンドル回転数に関するものとする。\\
...
\begin{2columnstable}[white]{\ttNum700\,-\ttNum724：\dimple~\DLone 用}{|Sc|Sl|}{番号}{内容}
\rowcolor{unusingVariables}
\ttNum700 & （予備）\\\hline
...
\begin{2columnstable}[white]{\ttNum725\,-\ttNum744：\dimple~\DLtwoAC\DLtwoBD 用}{|Sc|Sl|}{番号}{内容}
