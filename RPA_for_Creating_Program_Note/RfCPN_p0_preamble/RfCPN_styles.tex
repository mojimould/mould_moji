...
\newenvironment{2columnstable}[4]{%
  ...
  \commonTable{#1}{#2}{\textbf{#3} & \textbf{#4}}{2}%
}
{\endcommonTable}
%\NewTblrEnviron{2columnstable}[4]
%{%
...
%  \fi
%  \begin{commonTable}{#2}{\textbf{#3} & \textbf{#4}}{2}
%    \SetCell[r=2]{c} % corresponds to \cellspacetoplimit and \cellspacebottomlimit
%}
%{%
%  \end{commonTable}
%}
%%%%% 3columnstable %%%%%
\newenvironment{3columnstable}[5]{%
  \setlength\cellspacetoplimit{4.5pt}%
  \setlength\cellspacebottomlimit{4.5pt}%
  \commonTable{#1}{#2}{\textbf{#3} & \textbf{#4} & \textbf{#5}}{3}%
}
{\endcommonTable}
%%%%% 4columnstable %%%%%
\newenvironment{4columnstable}[6]{%
  \setlength\cellspacetoplimit{4.5pt}%
  \setlength\cellspacebottomlimit{4.5pt}%
  \commonTable{#1}{#2}{\textbf{#3} & \textbf{#4} & \textbf{#5} & \textbf{#6}}{4}%
}
{\endcommonTable}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
