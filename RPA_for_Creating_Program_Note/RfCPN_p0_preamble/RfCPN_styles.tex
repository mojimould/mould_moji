...
\newcommand{\commonheadfoot}{
  ...
  \fancyfoot[C]{\scriptsize
    \hyperref[chap:III.19]{コモン変数}\quad
    \hyperref[chap:III.A]{システム変数}\quad
    \hyperref[part:IV]{解析計算}\quad
    \hyperref[chap:VI.H]{Gコード}\quad
    \hyperref[sec:VI.H.2]{Mコード}\quad
    \hyperref[chap:VI.I]{プログラム}}
