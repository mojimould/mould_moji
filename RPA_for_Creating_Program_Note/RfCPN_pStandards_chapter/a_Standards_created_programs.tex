...
そのため、\pageautoref{subsec:notopenwork}に則り、記載は代表的なものに留める。\\
...
%% section E.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{測定用（内面溝除く）サブプログラム}
\addtocontents{lol}{\protect\addvspace{3pt}}{}{}
\addcontentsline{lol}{section}{\numberline{\thesection}\Sectionname}
...
%% section E.3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{加工用（内面溝除く）サブプログラム}
...
%% Prg. \KUchiMentoriRLeft %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KOLeft\,:外側 左回り1周}
\lstinputlisting[style=Gcode-more]{../Mould_Machining_Programs/sub_programs/\KOLeft}
...
%% section E.4 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{内面溝用 移動・測定・加工用サブプログラム}
\addtocontents{lol}{\protect\addvspace{10pt}}{}{}
\addcontentsline{lol}{section}{\numberline{\thesection}\Sectionname}
...
%% Prg. \OpauseCheck %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\OpauseCheck\,: \texorpdfstring{$\boldsymbol{90^\circ}$}{90°}回転 扉前一時停止}
