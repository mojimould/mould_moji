...
\item 工具番号31-35は\expandafterindex{\dimplekana かこう@\dimple 加工}\dimple 加工用工具（\index{Tスロットカッター}Tスロットカッター）とする
\item 工具番号36-40は\dimple 加工用工具（\index{アングルヘッド}アングルヘッド）とする
