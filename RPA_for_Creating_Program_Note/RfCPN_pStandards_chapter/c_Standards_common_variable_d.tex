...
%% section 11.3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\ttNum400\,-\ttNum474：加工時の調整\TBW}
\addtocontents{lot}{\protect\addvspace{3pt}}{}{}
\addcontentsline{lot}{section}{\numberline{\thesection}\Sectionname}
...
%% subsection 11.3.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\ttNum400\,-\ttNum412：主に測定時の調整\TBW}
\modcaptionof{table}{\ttNum400\,-\ttNum412：主に測定時の調整（\dimple 除く）\TBW}
\begin{twoCtable}{}
...
%% subsection 11.3.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\ttNum413\,-\ttNum449：加工時の調整（\dimple 除く）\TBW}
\modcaptionof{table}{\ttNum413\,-\ttNum415：端面加工の全削り代}
\begin{twoCtable}{}
...
\clearpage
\modcaptionof{table}{\ttNum416\,-\ttNum449：加工時の調整（端面・\dimple 除く）\TBW}
\begin{twoCtable}{}
...
\ttNum436 & トップ内面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum437 & トップ内面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum438 & （不使用）\\\hline
...
\ttNum444 & ボトム内面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum445 & ボトム内面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum446 & （不使用）\\\hline
& （以下予備）
\end{twoCtable}
...
%% subsection 11.3.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\ttNum450\,-\ttNum474：\dimple 深さの調整\TBW}
\modcaptionof{table}{\ttNum450\,-\ttNum474：\dimple 深さの調整\TBW}
\begin{twoCtable}{}
\ttNum450 & （不使用）\\\hline
