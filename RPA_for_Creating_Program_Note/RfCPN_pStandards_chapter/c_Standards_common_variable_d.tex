...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hosoku}
\ttNum475-\ttNum499については（\dateUnusedVariables 時点において）未使用。
\end{hosoku}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hosoku}
\ttNum625-\ttNum649については（\dateUnusedVariables 時点において）未使用。
\end{hosoku}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\modcaptionof{table}{\ttNum675\,-\ttNum699：工具の送り速さ\TBW}
\begin{twoCtable}{}
\ttNum675 & $Z$最大送り速さ値（タッチセンサープローブ除く） & 10800\\\hline
\ttNum676 & 最大送り速さ値（タッチセンサープローブ） & 5400\\\hline
\ttNum677 & アプローチ・リトラクト送り速さ値（タッチセンサープローブ除く） & 5400\\\hline
\ttNum678 & アプローチ・リトラクト送り速さ値（タッチセンサープローブ） & 1500\\\hline
\ttNum679 & アプローチ送り速さ値（片側測定時） & 50\\\hline
\ttNum680 & アプローチ送り速さ値（両側測定時） & 200\\\hline
\ttNum681 & 端面加工 直線 & 900\\\hline
\ttNum682 & 端面加工 コーナー & 900\\\hline
\ttNum683 & 外削加工 直線 & 400\\\hline
\ttNum684 & 外削加工 コーナー & 400\\\hline
\ttNum685 & 溝加工 直線 & 500\\\hline
\ttNum686 & 溝加工 コーナー & 400\\\hline
\ttNum687 & 外面取加工 直線 & 500\\\hline
\ttNum688 & 外面取加工 コーナー & 400\\\hline
\ttNum689 & 内面取加工 直線 & 400\\\hline
\ttNum690 & 内面取加工 コーナー & 400\\\hline
\ttNum691\TBW & 座ぐり加工 直線 & \\\hline
\ttNum692\TBW & 座ぐり加工 コーナー & \\\hline
\ttNum693 & \dimple 表面アプローチ & 540\\\hline
\ttNum694 & \dimple 加工  & 100\\\hline
& （以下予備）
\end{twoCtable}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hosoku}
\ttNum750-\ttNum899については（\dateUnusedVariables 時点において）未使用。
\end{hosoku}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
