...
\ttNum402 & （不使用）\\\hline
\hline
\ttNum403 & ボトム外$X$芯出し（両側・片側測定）測定位置$Z+$補正（$X$自動補正） & 0\\\hline
\ttNum404 & ボトム外$Y$芯出し（両側測定）測定位置$Z+$補正 & 0\\\hline
\ttNum405 & ボトム内$X$芯出し（両側測定）測定位置$Z+$補正（$X$自動補正） & 0\\\hline
\ttNum406 & ボトム内$Y$芯出し（両側測定）測定位置$Z+$補正 & 0\\\hline
\ttNum407 & （不使用）\\\hline
\ttNum408 & トップ外$X$芯出し（両側・片側測定）測定位置$Z+$補正（$X$自動補正） & 0\\\hline
\ttNum409 & トップ外$Y$芯出し（両側測定）測定位置$Z+$補正 & 0\\\hline
\ttNum410 & トップ内$X$芯出し（両側測定）測定位置$Z+$補正（$X$自動補正） & 0\\\hline
\ttNum411 & トップ内$Y$芯出し（両側測定）測定位置$Z+$補正 & 0\\\hline
\ttNum412 & （不使用）
\end{twoCtable}
