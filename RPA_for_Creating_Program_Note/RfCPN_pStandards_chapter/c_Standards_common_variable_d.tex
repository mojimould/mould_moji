...
\begin{2commonvariables}{\ttNum100\,-\ttNum110：一時保存値}{\ttNum 番号}{内容}
...
\begin{3commonvariables}{\ttNum175\,-\ttNum199：各工程後一時停止}{\ttNum 番号}{内容}{初期値}
\rowcolor{gray!20!}
\ttNum175 & （以下 予備） &\\\hline
\rowcolor{gray!20!}
...
\begin{3commonvariables}{\ttNum400\,-\ttNum404：初期設定}{\ttNum 番号}{内容}{初期値}
...
\begin{3commonvariables}{\ttNum405\,-\ttNum414：測定時の調整（\dimple 除く）}{\ttNum 番号}{内容}{初期値}
...
\clearpage
\begin{3commonvariables}{\ttNum415\,-\ttNum424：加工時の調整（端面・\dimple 除く）}{\ttNum 番号}{内容}{初期値}
...
\begin{3commonvariables}{\ttNum425\,-\ttNum449：加工時の調整（続き）}{\ttNum 番号}{内容}{初期値}
...
\begin{3commonvariables}{\ttNum450\,-\ttNum474：\dimple 深さの調整}{\ttNum 番号}{内容}{設定値}
...
\addtocontents{lot}{\protect\addvspace{3pt}}{}{}
\addcontentsline{lot}{section}{\numberline{\thesection}\Sectionname}
\ttNum500\,-\ttNum599については、\index{バンドルのプログラム}バンドルのプログラム(O910xおよびO93xx)で使用されるものとする。\\

\begin{3commonvariables}{\ttNum500\,-\ttNum599：O910x, O93xx用}{\ttNum 番号}{内容}{設定値}
...
\begin{3commonvariables}{\ttNum600\,-\ttNum624：ワークと工具間の距離の調整}{\ttNum}{内容}{設定値}
\rowcolor{gray!20!}
\ttNum600 & （予備） &\\\hline
...
\begin{3commonvariables}{\ttNum650\,-\ttNum674：残り代および1回あたりの削り代}{\ttNum 番号}{内容}{設定値}
...
\begin{3commonvariables}{\ttNum675\,-\ttNum699：工具の送り速さ}{\ttNum 番号}{内容}{設定値}
...
\begin{2commonvariables}{\ttNum700\,-\ttNum724：\dimple~レベル1サブプログラム用 (\DLone)}{\ttNum 番号}{内容}
\rowcolor{gray!20!}
\ttNum700 & （予備）\\\hline
...
\begin{2commonvariables}{\ttNum725\,-\ttNum744：\dimple~レベル2サブプログラム用 (\DLtwoAC, \DLtwoBD)}{\ttNum 番号}{内容}
...
%\clearpage
\begin{2commonvariables}{\ttNum745\,-\ttNum749：\dimple~測定用 (\DMLthreeAC, \DMLthreeBD)}{\ttNum 番号}{内容}
\rowcolor{gray!20!}
\ttNum745 & （以下 予備）\\\hline
\rowcolor{gray!20!}
~~~$\vdots$ & \qquad$\vdots$\\\hline
\ttNum748 & プログラム読込時ブロックエンド$X$ or $Y$ (\ttNum5001, \ttNum5002)\\\hline
\ttNum749 & \dimple~表面位置$X$ or $Y$測定値
\end{2commonvariables}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% hosoku %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{2commonvariables}{\ttNum900001\,-\ttNum900005：外中心$X$測定用 (\MXOThickness)}{\ttNum 番号}{内容}
...
\begin{2commonvariables}{\ttNum900006\,-\ttNum900010：外中心$Y$測定用 (\MYOThickness)}{\ttNum 番号}{内容}
...
%\clearpage
\begin{2commonvariables}{\ttNum900011\,-\ttNum900013：溝中心$X$測定用 (\MXOface)}{\ttNum 番号}{内容}
...
%\clearpage
\begin{2commonvariables}{\ttNum900014\,-\ttNum900018：内中心$X$測定用 (\MXIWidth)}{\ttNum 番号}{内容}
...
\clearpage
\begin{2commonvariables}{\ttNum900019\,-\ttNum900023：内中心$Y$測定用 (\MYIWidth)}{\ttNum 番号}{内容}
...
%\clearpage
\begin{2commonvariables}{\ttNum900024\,-\ttNum900026：外削中心$X$測定用 (\MXIface)}{\ttNum 番号}{内容}
...
%\clearpage
\begin{2commonvariables}{\ttNum900027\,-\ttNum900030：通り芯$X$測定用 (\MYcenterline)}{\ttNum 番号}{内容}
...
\begin{2commonvariables}{\ttNum900031\,-\ttNum900034：通り芯$X$測定用 (\MXcenterline)}{\ttNum 番号}{内容}
...
\begin{2commonvariables}{\ttNum900101\,-\ttNum900300：\dimple AC表面位置 測定値 (\DMLthreeAC)}{\ttNum 番号}{内容}
...
\begin{2commonvariables}{\ttNum900301\,-\ttNum900500：\dimple BD表面位置 測定値 (\DMLthreeBD)}{\ttNum 番号}{内容}
...
\begin{3commonvariables}{\ttNum901000\,-\ttNum901024：主にパレット・ジグ}{\ttNum 番号}{内容}{設定値}
\rowcolor{gray!20!}
\ttNum901000 & （予備） &\\\hline
...
\begin{3commonvariables}{\ttNum901100\,-\ttNum901149：工具}{\ttNum 番号}{内容}{設定値}
\rowcolor{gray!20!}
\ttNum901100 & （予備） &\\\hline
\ttNum901101 & 工具\verb|T02|（フェイスミル）最大刃径（直径）DCX公称値$\phi'_\mathrm D$ & 113.5\\\hline
\rowcolor{gray!20!}
\ttNum901102 & （端面加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901103 & （端面加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901104 & （端面加工工具用 予備） &\\\hline
\ttNum901105 & 工具\verb|T06|（サイドカッター）厚さ$t$ & 7.0\\\hline
\rowcolor{gray!20!}
\ttNum901106 & （溝加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901107 & （溝加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901108 & （溝加工工具用 予備） &\\\hline
\ttNum901109 & 工具\verb|T08|（サイドカッター）厚さ$t$ & 5.0\\\hline
\rowcolor{gray!20!}
\ttNum901110 & （溝加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901111 & （溝加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901112 & （溝加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
\ttNum901113 & （以下 C面取加工工具用 予備） &\\\hline
\rowcolor{gray!20!}
~~~$\vdots$ & \qquad$\vdots$ &\\\hline
\rowcolor{gray!20!}
...
\rowcolor{gray!20!}
~~~$\vdots$ & \qquad$\vdots$ &\\\hline
\ttNum901127 & \verb|T31| Tスロットカッターシャンク直径（公称値） & 25.0\\\hline
\rowcolor{gray!20!}
\ttNum901128 & （以下 \dimple 加工工具用 予備） &\\
\end{3commonvariables}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% hosoku %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\addtocontents{lot}{\protect\addvspace{3pt}}{}{}
\addcontentsline{lot}{section}{\numberline{\thesection}\Sectionname}
この章の各々の表に載せていないコモン変数は\dateUnusedVariables 時点において未使用であり、新たに用いても問題ない（他のプログラムと競合しない）。
