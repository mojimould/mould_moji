...
\ttNum426 & 溝A面深さ$+$補正（溝径中心$X-$補正） & 0\\\hline
...
\begin{twoCtable}{}
\ttNum431 & トップ外面取$X+$補正 & 0\\\hline
\ttNum432 & トップ外面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum433 & トップ外面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum434 & （不使用）\\\hline
...
\ttNum438 & （不使用）\\\hline
\ttNum439 & ボトム外面取$X+$補正 & 0\\\hline
\ttNum440 & ボトム外面取 仕上げ前 一時停止 (0:non-stop, 1:\verb|M00|, 2:\verb|P90003|) & 0\\\hline
\ttNum441 & ボトム外面取 仕上げ加工 追加回数 (上限3) & 0\\\hline
\ttNum442 & （不使用）\\\hline
...
\ttNum658\TBW & 内面取加工1回あたりの削り代（直径） & 2.0\\\hline
\ttNum659\TBW & 内面取加工 仕上げ前 残り削り代（直径） & 1.0\\\hline
