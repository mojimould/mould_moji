...
\prgbox{O7100} & 工具長補正値 自動計測 & \prgbox{O9100}\\
...
\prgbox{O9002} & No.1パレット & \prgbox{O9001}\\
\prgbox{O9003} & No.2パレット & \prgbox{O9001}\\
\prgbox{O9006} & 自動工具交換 &\\
\prgbox{O9020} & パレット認識マクロ & \prgbox{O8998}\\
\prgbox{O9021} & No.1パレットの選択確認 &\\
\prgbox{O9022} & No.2パレットの選択確認 &\\
\prgbox{O9100} & 工具長補正値 自動測定 &\\
\prgbox{O9101} & 工具長オフセット量の修正 &\\
\prgbox{O9102} & 工具破損検出 &\\
\prgbox{O9103} & 自動工具径測定 &\\
\prgbox{O9200} & パラメタ確認 &\\
\prgbox{O9300} & プローブの倒れの補正量の測定 & \prgbox{O9392}\prgbox{O9393}\\
