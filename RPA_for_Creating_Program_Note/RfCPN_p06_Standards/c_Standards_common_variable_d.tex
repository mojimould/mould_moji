...
\SetRow{unusingVariables}
\ttNum186\TBW & （端面座ぐり 仕上げ加工 追加回数用 予備） & 0\\
\SetRow{unusingVariables}
\ttNum187 & （不使用） &\\
...
\ttNum476 & （不使用） &\\
\SetRow{unusingVariables}
\ttNum477\TBW & （端面座ぐり$X+$補正用 予備） & 0\\
\SetRow{unusingVariables}
\ttNum478\TBW & （端面座ぐり径 補正用 予備） & 0\\
\ttNum479 & 端面座ぐり 仕上げ前 一時停止 (0:{\ttfamily M00}, 1:non-stop, 2:扉前{\ttfamily M00}) & 1\\
\ttNum480 & 端面座ぐり 仕上げ後 一時停止 (0:{\ttfamily M00}, 1:non-stop, 2:扉前{\ttfamily M00}) & 1\\
\SetRow{unusingVariables}
\ttNum481 & （不使用） &\\
\SetRow{unusingVariables}
\ttNum482 & （予備） &\\
...
\ttNum668 & 端面座ぐり加工：直線 & 40\\
\ttNum669 & 端面座ぐり加工：コーナー & 40\\
