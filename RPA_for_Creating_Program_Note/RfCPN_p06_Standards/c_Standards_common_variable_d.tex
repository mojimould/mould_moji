...
\modHeadchapter[lot]{コモン変数（\DMname）\label{chap:commonvariablesDM}}
ここでは\DMname の加工システムで使用している\expandafterindex{コモンへんすう（\DMname）@コモン変数（\DMname）}コモン変数について述べる。
...
\ttNum670 & 内面\dimple 測定：表面アプローチ & 600\\
\ttNum671 & 内面\dimple 加工：加工 & 100\\
\SetRow{unusingVariables}
\ttNum672 & （予備） & \\
\SetRow{unusingVariables}
\ttNum673 & （予備） & \\
