...
\ttNum179 & トップ端面削加工後 一時停止 (0:{\ttfamily M00}, 1:non-stop, 2:扉前{\ttfamily M00}) & 1\\
\ttNum180 & ボトム端面削加工後 一時停止 (0:{\ttfamily M00}, 1:non-stop, 2:扉前{\ttfamily M00}) & 1\\
\SetRow{unusingVariables}
\ttNum181 & （不使用） &\\
...
変数 & 内容 & 設定例\\
\ttNum625 & 端面削加工1回あたりの$Z$方向削り代 & 4.0\\
\SetRow{unusingVariables}
\ttNum626 & （予備） & \\
...
\SetRow{unusingVariables}
\ttNum657 & （不使用） &\\
\ttNum658 & 端面削加工：直線 & \EndFaceLinearFeedRate\\
\ttNum659 & 端面削加工：コーナー & \EndFaceCornerFeedRate\\
...
変数 & 内容 & 設定例\\
\ttNum675 & 端面削加工 & \EndFaceSpindleSpeed\\
...
\clearpage
\begin{multicollongtblr}[white]{\ttNum900027\,-\ttNum900030：\CenterlineEndFaceDifBD{} 片側測定用 \MYcenterline}{cX[l]}
変数 & 内容\\
...
%\clearpage
\begin{multicollongtblr}[white]{\ttNum900034\,-\ttNum900037：\CenterlineEndFaceDifAC{} 片側測定用 \MXcenterline}{cX[l]}
変数 & 内容\\
...
\SetRow{unusingVariables}
\ttNum901102 & （端面削加工工具{\ttfamily T02}-{\ttfamily T05}用 予備） &\\
\SetRow{unusingVariables}
\ttNum901103 & （端面削加工工具{\ttfamily T02}-{\ttfamily T05}用 予備） &\\
\SetRow{unusingVariables}
\ttNum901104 & （端面削加工工具{\ttfamily T02}-{\ttfamily T05}用 予備） &\\
