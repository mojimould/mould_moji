...
\ttNum664 & 端面外C面取加工：直線 & \OutChamferLinearFeedRate\\
\ttNum665 & 端面外C面取加工：コーナー & \OutChamferCornerFeedRate\\
\ttNum666 & 端面内C面取加工：直線 & \InChamferLinearFeedRate\\
\ttNum667 & 端面内C面取加工：コーナー & \InChamferCornerFeedRate\\
...
\ttNum678 & 端面外C面取加工 & \OutChamferSpindleSpeed\\
\ttNum679 & 端面内C面取加工 & \InChamferSpindleSpeed\\
...
\ttNum716 & BD内半径$+$\PlatingThk$-\text{\ttNum703}-\text{\ttNum620}$\\
\ttNum717 & (AC内半径$+$\PlatingThk$-\text{\ttNum703}-\text{\ttNum620}\text)\cos\phi$\\
