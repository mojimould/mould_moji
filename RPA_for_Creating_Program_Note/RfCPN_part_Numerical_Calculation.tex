...
\end{align*}
ジグ（長さ$2l$）からの\index{はりだしちょう@張出長}張出長に換算するならば、それぞれ
\begin{align*}
  f_\mathrm T+\varDelta_x'\!\sin\theta-l~~, \quad
...
\begin{align*}
  \frac{\sqrt{R_\mathrm o^2-f_\mathrm T^2}+\sqrt{R_\mathrm i^2-f_\mathrm T^2}}2-\varDelta_x'\cos\theta~, \quad
...
\begin{align*}
  \sqrt{R_\mathrm c^2-f_\mathrm T^2}-\varDelta_x'\!\cos\theta~, \quad
...
%% subsection 10.4.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{A側溝深さ指定の場合\TBW}
(to be written...)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% subsubsection 30.4.3.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
