...
\begin{enumerate}[label=\sarrow]
\item \index{こうさ（\yomiWorkTotalLength）@公差（\nameWorkTotalLength）}\nameWorkTotalLength の公差を確認し、\TopAlocationLength および\BottomAlocationLength の\index{こうさ（\yomiAlocationLength）@公差（\nameAlocationLength）}公差の判断を行う
