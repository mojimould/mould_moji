...
\DMname において作成した\index{メインプログラム}メインプログラムは以下のとおりである
%% footnote %%%%%%%%%%%%%%%%%%%%%
\footnote{ここでいうメインプログラムとは、\index{せいひんばんごう@製品番号}製品場号と同一の\index{プログラムばんごう@プログラム番号}プログラム番号のものを指す。
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{サブプログラム}
\DMname において作成した\index{サブプログラム}サブプログラムは以下のとおりである
%% footnote %%%%%%%%%%%%%%%%%%%%%
\footnote{ここでいうサブプログラムとは、\index{せいひんばんごう@製品番号}製品場号と同一の\index{プログラムばんごう@プログラム番号}プログラム番号以外のものを指す。}。\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\MXOface      & 測定 片側 溝中心$X$ & \OsensorOff\\
...
{\ttfamily O}番号 & 内容 & 使用prg\\
\MYcenterline & 測定 片側 通り芯$Y$ & \OsensorOff\\
\MXcenterline & 測定 片側 通り芯$X$（$Z$方向測定） & \OsensorOff\\
\end{multicollongtblr}
...
%% Prg. \MXOThickness %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\MainExOne：両外削・外面取・内面取・内面溝あり}
