...
ただし、ここでは例として挙げているので、\pageautoref{subsec:notopenwork}に則り、プログラム番号は本来のものから変更している。
\end{marker}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\index{メインプログラム}メインプログラムについては、個々の\index{めいさい@明細}明細の情報（社内機密情報）を含む。
そのため、\pageautoref{subsec:notopenwork}に則り、記載は代表的・典型的なものに留める。\\

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Prg. \MainExOne %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\MainExOne：両外削・外面取・内面取・\dimple あり}
...
%% Prg. \MainExTwo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\MainExTwo：外面取・内面取・\dimple あり\TBW}
%\lstinputlisting[style=Gcode-more]{../Mould_Machining_Programs/main_programs/\nameMainExTwo}
...
%% Prg. \MYOThickness %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\MXOface\,:測定 片側 溝中心\texorpdfstring{$X$}{X}（A側外面側測定）\TBW}
%\lstinputlisting[style=Gcode-more]{../Mould_Machining_Programs/sub_programs/\nameMXOface.nc}
