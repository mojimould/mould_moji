...
%% subsection 27.3.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{ボトム側が基準の場合}
回転によるずれを考慮すると、ボトム振分長$f_\mathrm B'$およびボトム側の外削中心$\mathcal G_\mathrm B$が基準の場合、（テーブル中心Pを原点とした）トップ側の外削中心の$X$座標$\mathcal G_{\mathrm Tx}$およびトップ振分長$f_\mathrm T'$は、
\begin{align*}
  \mathcal G_{\mathrm Tx} = -\mathcal G_{\mathrm Bx}+T_x-\delta x\ ,\qquad
  f_\mathrm T' = (f_\mathrm T+f_\mathrm B)-f_\mathrm B'+\delta z\ .
\end{align*}
よって、ボトム側（$-X$側）およびトップ側（$+X$側）の\index{Cがわがいさくめん@C側外削面}C側外削面の中心は、\pageeqref{eq:centerlineB}より、
\begin{align*}
  \text{ボトム側：}\quad
  \left[
    \begin{array}{c}
  ...
  \left[
    \begin{array}{c}
      \displaystyle (f_\mathrm T+f_\mathrm B)-f_\mathrm B'-\frac{\kappa_p}2+\delta z\\[5pt]
      \mathcal G_{\mathrm By}-T_y\\[3pt]
...
%% subsection 27.3.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{トップ側が基準の場合}
回転によるずれを考慮すると、トップ振分長$f_\mathrm T'$およびトップ側の外削中心$\mathcal G_\mathrm T$が基準の場合、（テーブル中心Pを原点とした）墓ボトム側の外削中心の$X$座標$\mathcal G_{\mathrm Bx}$およびボトム振分長$f_\mathrm B'$は、
\begin{align*}
  \mathcal G_{\mathrm Bx} = -\mathcal G_{\mathrm Tx}+T_x-\delta x\ ,\qquad
  f_\mathrm B' = (f_\mathrm T+f_\mathrm B)-f_\mathrm T'+\delta z\ .
\end{align*}
よって、トップ側（$+X$側）およびボトム側（$-X$側）の\index{Cがわがいさくめん@C側外削面}C側外削面の中心は、\pageeqref{eq:centerlineT}より、
\begin{align*}
  \text{トップ側：}~~
  \left[
    \begin{array}{c}
  ...
  \left[
    \begin{array}{c}
      \displaystyle -(f_\mathrm T+f_\mathrm B)+f_\mathrm T'+\frac{h_\mathrm B}2-\delta z\\[5pt]
      \mathcal G_{\mathrm Ty}+T_y\\[3pt]
      \displaystyle \mathcal G_{\mathrm Tx}+T_x+\frac{\mathfrak W_\mathrm B}2
    \end{array}
  \right].
