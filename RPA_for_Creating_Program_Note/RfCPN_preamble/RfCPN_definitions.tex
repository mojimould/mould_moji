...
\input{RfCPN_preamble/RfCPN_pictures}
...
\newcommand\OpauseCheck{O900003} % 扉前移動一時停止
\newcommand\OtoolLengthA{O907100} % 全工具 工具長測定
\newcommand\OtoolLength{O909100} % 工具長測定
...
{%
  ...
  \hline
  \rowcolor{orange!20}
  \textbf{記号} & \textbf{内容}\hspace*{0.5\textwidth} & \textbf{#2}\\
  \hline
  \endfirsthead
  \hline
  \rowcolor{orange!20}
