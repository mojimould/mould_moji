...
\newcommand{\commonheadfoot}{
  ...
  \fancyfoot{}
  \fancyfoot[C]{\tiny
    \hyperref[part:I]{Part\,I}\quad
    \hyperref[part:II]{Part\,II}\quad
    \hyperref[part:III]{Part\,III}\quad
    \hyperref[part:IV]{Part\,IV}\quad
    \hyperref[part:V]{Part\,V}\quad
    \hyperref[part:VI]{Part\,VI}\quad
    \hyperref[part:VII]{Part\,VII}\quad
    \hyperref[part:VIII]{Part\,VIII}}
...
%\renewcommand*\l@figure{\@dottedtocline{1}{1.8em}{3.2em}}
...
%\renewcommand*\l@lstlisting{\@dottedtocline{1}{1.0em}{3.2em}}
...
\newenvironment{2columnstable}[3]
{\commonTable{#1}{|c|Sl|}{\textbf{#2} & \textbf{#3}}{2}}
{\endcommonTable}
\newenvironment{3columnstable}[4]
{\commonTable{#1}{|l|Sl|c|}{\textbf{#2} & \textbf{#3} & \textbf{#4}}{3}}
{\endcommonTable}

\newenvironment{2commonvariables}[3]
{\commonvariables{#1}{|c|Sl|}{\textbf{#2} & \textbf{#3}}{2}}
{\endcommonvariables}
\newenvironment{3commonvariables}[4]
{\commonvariables{#1}{|l|Sl|c|}{\textbf{#2} & \textbf{#3} & \textbf{#4}}{3}}
{\endcommonvariables}
