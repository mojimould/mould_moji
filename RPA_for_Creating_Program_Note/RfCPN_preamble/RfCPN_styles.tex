...
%  pdfcreator={upLaTeX with hyperref}, % creator for PDF subjct field
  pdftitle={RPA実現に向けたRDBSの設計と構築}, % title for PDF subjct field
...
%\RedeclareSectionCommand[
%  tocnumwidth=2.4em % section # の幅を調整
%]{part}
%\RedeclareSectionCommand[
%  tocnumwidth=2.71em % section # の幅を調整
%]{section}
%\RedeclareSectionCommand[
%  tocindent=4.21em, % subsection のインデントを調整
%  tocnumwidth=3.25em % subsection # の幅を調整
%]{subsection}
%\RedeclareSectionCommand[
%  tocindent=7.46em, % subsubsection のインデントを調整
%  tocnumwidth=3.75em % subsubsection # の幅を調整
%]{subsubsection}
\DeclareTOCStyleEntry[
%  indent=1.5em, % エントリのインデントを調整
  numwidth=2.35em % エントリ番号の幅を調整
]{tocline}{part}
\DeclareTOCStyleEntry[
  indent=2.35em, % エントリのインデントを調整
%  numwidth=2.4em % エントリ番号の幅を調整
]{tocline}{chapter}
\DeclareTOCStyleEntry[
  indent=4.21em, % エントリのインデントを調整
  numwidth=2.71em % エントリ番号の幅を調整
]{tocline}{section}
\DeclareTOCStyleEntry[
  indent=6.92em, % エントリのインデントを調整
  numwidth=3.25em % エントリ番号の幅を調整
]{tocline}{subsection}
\DeclareTOCStyleEntry[
  indent=10.17em, % エントリのインデントを調整
...
\renewcommand*\l@table{\@dottedtocline{1}{1.0em}{3.2em}}
