...
(if Y/2+M-#901148-#602 <= 0, go to N800)
...
N010
G90 G31 Z[#26-#901148-#30] F#653
(Z tanmen: Z-#901148-#30)
IF[#5003GT[#26-#901148-#30]]GOTO802
(if skip Z > Z-#901148-#30, to N802)

N011
G91 G31 Y-[#29-#901148-#602] F#653
(Y- skip: [#29-#901148-#602])
IF[[ABS[#5002-#32]+0.001]LT[ABS[#29-#901148-#602]]]GOTO803
(if |skip Y -#32| < |#29-#901148-#602|, to N803)

G91 G31 Y-[#602+#603] F#655
(Y- skip: #602+#603)
#900019=#5002-#901148+#501+#503
(#900019= Y bellow side -#901148 +probe hosei)
...
G91 G31 Y[#602+#603] F#655
(Y+ skip: #602+#603)
#900020=#5002+#901148-#501+#503
(#900020= Y above side +#901148 +probe hosei)
