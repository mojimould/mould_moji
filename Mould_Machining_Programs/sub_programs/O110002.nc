...
N009
G91 G01 Y-[[#25/2]+#901148+#602] F#652
(Y-: [BD gaikei/2 +#901148+#602])

G90 G31 Z[#26-#901148-#31] F#653
(Z skip: Z-#901148-#31)
IF[#5003GT[#26-#901148-#31]]GOTO802
(if skip Z > Z-#901148-#31, to N802)

N010
G91 G31 Y[#602+#603] F#655
(Y+ skip: #602+#603)
#900006=#5002+#901148-#501+#503
(#900006= Y bellow side +#901148 +probe hosei)

N011
G91 G01 Y-[#602+#603] F#652
(Y-: #602+#603)
G91 G01 Z[#31+#901148+#600] F#650
(Z+: #31+#901148+#600)
...
G91 G31 Y-[#602+#603] F#655
(Y- skip: #602+#603)
#900007=#5002-#901148+#501+#503
(#900007= Y above side -#901148 +probe hosei)
