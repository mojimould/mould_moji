...
G91 G31 Y-[#603+#604] F#679
(Y- skip: #603+#604)
#900027=#5002-#512+#501+#503
(#900027= Y bot above side -#512 +probe hosei)

G91 G01 Y[#603*2] F#676
(Y+: #603*2)

G91 G28 Z0
IF[[ABS[#900027-#501-#503]]LE[ABS[[#02/2]-#603]]]GOTO800
(if |#900027|<=|B/2-#603|, go to N800)
...
G91 G01 X[-2*[#5221-#33]+#21] F#676
G90 G54 G01 Y[[#20/2]+#512+#603] F#676
...
IF[[ABS[#900028-#501-#503]]LE[ABS[[#20/2]-#603]]]GOTO800
(if |#900028|<=|T/2-#603|, go to N800)
