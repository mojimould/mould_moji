...
N007
IF[#4012EQ56]THEN #29=#24+#415
IF[#4012EQ54]THEN #29=#24+#437
IF[#4012EQ56]THEN #28=#25+#415
IF[#4012EQ54]THEN #28=#25+#437
...
N103
G90 G01 X[[#104/2]+#30*2+#33] Y[#105/2] F#651
G65 P490005 K1. R#18 X#104 Y#105 D#30 F#660 E#661 S#676
...
IF[#4012EQ54]THEN #106=FUP[#188]
(Top: #106=FUP[#182]. Bot: #106=FUP[#188])
...
N201
G90 G00 X[[#29/2]+#30*3+#33] Y[#28/2] F#650
G42 D#4120
...
N203
G90 G01 X[[#29/2]+#30*2+#33] Y[#28/2] F#651
G65 P490005 K1. R#18 X#29 Y#28 D#30 F#660 E#661 S#676
G90 G40 G00 X[[#29/2]+#30*3+#33]
END2
...
(Passed arguments)
(#18, #28, #29, #30, #104, #105, #660, #661, #676)
%