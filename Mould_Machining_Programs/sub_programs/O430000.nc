...
(#102=max[#100, #101])
IF[#102LE#655]GOTO015
(if #102 <= #655, go to N015)
#103=FUP[[#102-#655]/[#654*2]]
IF[#103LT0]GOTO800
(#103: kakou kaisuu)
...
WHILE[#103GE1]DO1
#103=#103-1
#104=#24+#655+[#654*2]*#103
#105=#25+#655+[#654*2]*#103

N101 (top side)
G90 G01 Z[#26-#13-#419-#31] S#19 F#675
...
N106 (bot side)
G90 G01 Z[#26-#13-#23-#419-#420] S#19 F#675
G90 G00 Y[#105/2]
G42 D#07
G91 G00 X-[#32/2]
...
N203
G90 G01 X[[#24/2]+#32*2-#421] Y[#25/2] F#677
...
(#102, #103, #104, #105, #106)
(as RHS)
(#419, #420, #421, #422, #423, #424, #600, #605, #654, #655, #675, #677)
