...
G91 G01 X-[[#24/2]+#901148+#602] F#652
(X-: [AC gaikei/2 +#901148+#602])
...
(X+ skip: #602+#603)
#900001=#5001+#901148-#501+#502
(#900001= X left side +#901148 +probe hosei)

N012
G91 G01 X-[#602+#603] F#652
(X-: #602+#603)
G91 G01 Z[#30+#901148+#600] F#650
(Z+: #30+#901148+#600)
IF[[ABS[#900001+#501-#502]]LE[ABS[[#24/2]-#602]]]GOTO800
...
G91 G31 X-[#602+#603] F#655
(X- skip: #602+#603)
#900002=#5001-#901148+#501+#502
(#900002= X right side -#901148 +probe hosei)
...
G91 G01 Z[#30+#901148+#600] F#650
(Z+: #30+#901148+#600)
IF[[ABS[#900002-#501-#502]]LE[ABS[[#24/2]-#602]]]GOTO800
