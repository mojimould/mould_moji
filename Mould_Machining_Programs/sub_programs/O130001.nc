...
IF[#33LE55]THEN #31=-1
(Top: #31=1, Bot: #31=-1)
IF[#33GE56]THEN #30=#411
IF[#33LE55]THEN #30=#406
...
(#29= X/2+M)
(#28: X hosei from #30)
IF[[#29-#901148-#602]LE0]GOTO800
IF[[ABS[#28]]GE[#24/4]]GOTO800
(if X/2+M-#901148-#602 <= 0, go to N800)
...
N010
G90 G31 Z[#26-#901148] F#653
(Z skip: Z-#901148)
IF[#5003GT[#26-#901148]]GOTO802
(if skip Z > Z-#901148, to N802)

G91 G31 X[#31*#28] Z-#30 F#653
(X skip to #31*#28)
(Z skip to Z-#901148-#30)
IF[#5001GT[#32+#31*#28+0.001]]GOTO803
IF[#5003GT[#26-#901148-#30]]GOTO802
(if skip X > #32+#31*#28, to N802)
(if skip Z > Z-#901148-#30, to N802)

N011
G91 G31 X-[#29-#901148-#602] F#653
(X- skip: [#29-#901148-#602])
IF[[ABS[#5001-#32-#31*#28]+0.001]LT[ABS[#29-#901148-#602]]]GOTO803
(if |skip X -#32| < |#29-#901148-#602|, go to N803)

G91 G31 X-[#602+#603] F#655
(X- skip: #602+#603)
#900014=#5001-#901148+#501+#502
(#900014= X left side -#901148 +probe hosei)

N012
G90 G01 X[#32+#31*#28] F#652
(X to start point +hosei)
IF[[ABS[#900014-#501-#502]]GE[ABS[#29+#602]]]GOTO800
(if |#900014 -probe hosei| >= |#29+#602|, go to N800)

N013
G91 G31 X[#29-#901148-#602] F#653
(X+ skip: [#29-#901148-#602])
IF[[ABS[#5001-#32-#31*#28]+0.001]LT[ABS[#29-#901148-#602]]]GOTO803
(if |skip X -#32| < |#29-#901148-#602|, to N803)

G91 G31 X[#602+#603] F#655
(X+ skip: #602+#603)
#900015=#5001+#901148-#501+#502
(#900015= X right side +#901148 +probe hosei)
...
N015
G90 G01 X#900016 F#652
(X to measured center)
G91 G01 X-[#31*#28] Z#30 F#652
(X to measured tanmen center)
IF[[ABS[#900015+#501-#502]]GE[ABS[#29+#602]]]GOTO800
(if |#900015 -probe hosei|>=|#29+#602|, go to N800)
...
(as RHS)
(#406, #411, #600, #602, #603, #650, #652, #653, #655)
