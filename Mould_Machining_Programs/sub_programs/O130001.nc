...
(#29= X/2+M)
(#28: X hosei from #30)
IF[[#29-#512-#602]LE0]GOTO800
IF[[ABS[#28]]GE[#24/4]]GOTO800
(if X/2+M-#512-#602 <= 0, go to N800)
...
N011
G91 G31 X-[#29-#512-#602] F#653
(X- skip: [#29-#512-#602])
IF[[ABS[#5001-#32-#31*#28]+0.001]LT[ABS[#29-#512-#602]]]GOTO803
(if |skip X -#32| < |#29-#512-#602|, go to N803)
...
(X+ skip: [#29-#512-#602])
IF[[ABS[#5001-#32-#31*#28]+0.001]LT[ABS[#29-#512-#602]]]GOTO803
(if |skip X -#32| < |#29-#512-#602|, to N803)
