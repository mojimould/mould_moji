...
\ttNum416 & ボトム外削 仕上げ前stop (0:non-stop, 1:外削径1mm残し\verb|M00|) & 0\\\hline
\ttNum417 & ボトム外削 仕上げ加工回数 (上限5) & 1\\\hline
\ttNum418 & トップ外削 A面肉厚$+$補正（\verb|G56|ワーク座標系補正） & 0\\\hline
\ttNum419 & トップ外削 仕上げ前stop (0:non-stop, 1:外削径1mm残し\verb|M00|) & 0\\\hline
\ttNum420 & トップ外削 仕上げ加工回数 (上限5) & 1\\\hline
\ttNum421 & （予備）\\\hline
\ttNum422 & 溝位置$+$補正 & 0\\\hline
\ttNum423 & 溝幅$+$補正 & 0\\\hline
\ttNum424 & 溝A面深さ$+$補正（\verb|G56|ワーク座標系補正） & 0\\\hline
\ttNum425 & 溝 仕上げ前stop (0:non-stop, 1:溝径1mm残し\verb|M00|) & 0\\\hline
\ttNum426 & 溝 仕上げ加工回数 (上限5) & 1\\\hline
\ttNum425 & （予備）
\end{twoCtable}
...
\begin{twoCtable}{}
\ttNum426 & トップ外面取$X+$補正（\verb|G56|ワーク座標系補正）\\\hline
\ttNum427 & トップ外面取 仕上げ前stop (0:non-stop, 1:$Z+1$mm手前\verb|M00|)\\\hline
\ttNum428 & トップ外面取 仕上げ加工回数 (上限5)\\\hline
\ttNum429 & （予備）\\\hline
\ttNum430 & トップ内面取$X+$補正（\verb|G57|ワーク座標系補正）\\\hline
\ttNum431 & トップ内面取 仕上げ前stop (0:non-stop, 1:$Z+1$mm手前\verb|M00|)\\\hline
\ttNum432 & トップ内面取 仕上げ加工回数 (上限5)\\\hline
\ttNum433 & （予備）\\\hline
\ttNum434 & ボトム外面取$X+$補正（\verb|G54|ワーク座標系補正）\\\hline
\ttNum435 & ボトム外面取 仕上げ前stop (0:non-stop, 1:$Z+1$mm手前\verb|M00|)\\\hline
\ttNum436 & ボトム外面取 仕上げ加工回数 (上限5)\\\hline
\ttNum437 & （予備）\\\hline
\ttNum438 & ボトム内面取$X+$補正（\verb|G55|ワーク座標系補正）\\\hline
\ttNum439 & ボトム内面取 仕上げ前stop (0:non-stop, 1:$Z+1$mm手前\verb|M00|)\\\hline
\ttNum440 & ボトム内面取 仕上げ加工回数 (上限5)\\\hline
& （以下予備）
\end{twoCtable}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hosoku}
\ttNum451-\ttNum454の値は2024/01/16時点のものである。
\end{hosoku}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
