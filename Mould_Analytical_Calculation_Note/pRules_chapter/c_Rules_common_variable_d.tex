...
%\clearpage
\noindent\ttNum100\,-\ttNum105については、主に各々の製品明細または個々の製品に固有のものとする。\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% common variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ttNum104 & 端面 切削回数 (FUP[\ttNum412\,/\ttNum610] or FUP[\ttNum413\,/\ttNum610])
\end{twoCtable}
...
\ttNum414 & （予備）\\\hline
\ttNum415 & ボトム外削 A面肉厚$+$補正（\verb|G54|ワーク座標系補正）\\\hline
\ttNum416 & ボトム外削 仕上げ前stop (0:non-stop, 1:外削径1mm残し\verb|M00|)\\\hline
\ttNum417 & ボトム外削 仕上げ加工回数 (上限5)\\\hline
\ttNum418 & トップ外削 A面肉厚$+$補正（\verb|G56|ワーク座標系補正）\\\hline
\ttNum419 & トップ外削 仕上げ前stop (0:non-stop, 1:外削径1mm残し\verb|M00|)\\\hline
\ttNum420 & トップ外削 仕上げ加工回数 (上限5)\\\hline
\ttNum421 & （予備）\\\hline
\ttNum422 & 溝位置$+$補正\\\hline
\ttNum423 & 溝幅$+$補正\\\hline
\ttNum424 & 溝A面深さ$+$補正（\verb|G56|ワーク座標系補正）\\\hline
\ttNum425 & 溝 仕上げ前stop (0:non-stop, 1:溝径1mm残し\verb|M00|)\\\hline
\ttNum426 & 溝 仕上げ加工回数 (上限5)\\\hline
\ttNum425 & （予備）
\end{twoCtable}
...
\addtocontents{lot}{\protect\addvspace{3pt}}{}{}
\addcontentsline{lot}{section}{\numberline{\thesection}\Sectionname}
\ttNum600\,-\ttNum674については、主に製品と工具間の距離に関するものとする。\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% common variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ttNum609 & （予備）\\\hline
\ttNum610 & 端面加工 1回あたりの$Z$方向削り代 & 4.0\\\hline
& （以下予備）
\end{twoCtable}
...
%% common variables %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{table}{コモン変数 (\ttNum901100\,-\ttNum901199)}
\begin{twoCtable}{}
\ttNum901100 & （予備）\\\hline
\hline
