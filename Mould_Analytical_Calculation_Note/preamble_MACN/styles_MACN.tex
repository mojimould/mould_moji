...
\renewcommand*\backmatter{%
  \if@openright\cleardoubleoddpage\else\clearpage\fi\@frontmatterfalse\@mainmatterfalse\@backmattertrue\pagestyle{plainhead}
}
%%%%% WATERMARK %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%% STYLE OF LISTINGS %%%%%
\renewcommand{\lstlistlistingname}{プログラム 一覧}
...
\renewcommand{\thepart}{第\hx\Roman{part}\hx 部}
