...
\AtBeginDocument{
  ...
  \renewcommand{\thelstlisting}{\thechapter.\ifnum\value{lstlisting}<10 0\fi\arabic{lstlisting}.}
}
%%%%% NAME, AUTOREFNAME %%%%%%%%%%%%%%%%%%%%%%%%%%%%
