...
\newcommand{\modcaptionof}[2]{%
  \captionof{#1}{%
    ...
    \ifnum\value{#1}<10 0\fi
      \arabic{#1}. #2}}
\newcommand{\modTcaptionof}[3]{%
  \begin{caption}{\csname #1name\endcsname\thechapter.\ifnum\value{#1}<10 0\fi\arabic{#1}. #2}
  #3
  \end{caption}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% FOR TOC %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\pretocmd{\section}{\ifnum\value{section}=0\addtocontents{toc}{\protect\nopagebreak}\fi}{}{}
...
\newcommand{\Appendixpart}{
  \part*{\thepart の補遺}
  \addcontentsline{toc}{part}{\thepart の補遺}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% AUTO LABELING %%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \DeclareNewLayer[
    ...
    contents={%
      \begin{tikzpicture}[remember picture, overlay]
        \node[rotate=#2, scale=#3, anchor=center, opacity=0.1, text=lightgray] at (current page.center){\scshape#1};%
      \end{tikzpicture}%
    }%
  ]{WatermarkLayer}
}
...
\newcommand\KTanmenRight{O410000} % 端面用 コーナーR 右回り
\newcommand\KGaisakuRLeft{O420000} % 外側 コーナーR 左回り
\newcommand\KMizoConerLeft{O430000} % 溝用 コーナーRC 左回り
\newcommand\KUchiMentoriRLeft{O450000} % 内側面取用 コーナーR 左回り
\newcommand\KSotoMentoriRLeft{O440000} % 外側面取用 コーナーR 左回り
...
%%%%% OTHER DEFINITION %%%%%%%%%%%%%%%%%%
\newcommand\pcrNum{\ifmmode{\text{\texttt\#}}\else\texttt\#\fi}
