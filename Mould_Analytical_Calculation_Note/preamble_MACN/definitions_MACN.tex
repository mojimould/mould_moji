...
\DeclareNewLayer[
  ...
  contents={%
    \begin{tikzpicture}[remember picture, overlay]
      \node[rotate=atan(297/210), scale=29.5, anchor=center, opacity=0.1, text=lightgray] at (current page.center)
        {\scshape\WMsentence};%
    \end{tikzpicture}%
  }%
]{WatermarkLayer}
...
\newcommand\KMizoConerLeft{O432000} % 溝用 コーナーRC 左回り
...
%%%%% OTHER DEFINITION %%%%%%%%%%%%%%%%%%
\newcommand\pcrNum{\ifmmode{{\fontfamily{pcr}\selectfont{\text\#}}}\else{{\fontfamily{pcr}\selectfont\#}}\fi}
