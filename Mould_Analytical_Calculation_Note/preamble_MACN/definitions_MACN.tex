...
\tcbset{
  ...
  %%%%% TWOCTABLE STYLE %%%%%
  twoctable/.style 2 args={
      tabularx*={\arrayrulewidth0.5mm}{l|>{\centering\arraybackslash}X|X},
      title=#1, enhanced, fonttitle=\bfseries\large, fontupper=\normalsize\sffamily,
      colframe=black!50!black, colbacktitle=blue!10!white,
      coltitle=black,
      every row/.style 2 args={
          ##1/.style={colback=gray!50},
          ##2/.style={colback=white},
      },
      #2
    },
}
