...
\newcommand\MXface{O110101} % 外削X基準面計測
...
\newcommand\KRecRight{O515000} % 端面用 コーナーR 右回り
\newcommand\KICRLeft{O515200} % 内側 コーナーR 左回り
\newcommand\KOCRLeft{O515600} % 外側 コーナーR 左回り
\newcommand\KOKRCLeft{O515610} % 溝 コーナーR or C 左回り
