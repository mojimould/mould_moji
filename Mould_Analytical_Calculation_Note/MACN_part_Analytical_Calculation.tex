...
その原点の$X$座標（\index{じっそくち@実測値}実測値）を$G_{mx}$とすると、\index{みぞはばちゅうおう@溝幅中央}溝幅中央に対する\index{Aがわがいめん@A側外面}A側外面と\index{みぞちゅうしん@溝中心}溝中心$G_{mx}$との差は、
%% label{eq:mizocenterA}
\begin{align}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{外削のある場合}
トップ側に外削があり、かつ\index{Aがわみぞふかさ@A側溝深さ}A側溝深さの指定されている場合を考える。
