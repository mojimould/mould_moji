...
一般に、個々の製品や工具等の寸法は異なり、すべて固有の寸法等を持つ。
...
それに伴い、前段階で導出した解析の結果を用いて、ここでは属人性を極力排除する形で必要な数値情報が得られるシステムの提供を試みる。
}
...
\hline
\rowcolor{orange!20} % ヘッダ行の背景色を白に設定
\textbf{記号} & \textbf{内容}\\
\hline
\endfirsthead
...
\hline
\multicolumn{2}{|r|}{\scriptsize 次ページへ続く} \\
\hline
\endfoot
