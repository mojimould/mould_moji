...
\end{align*}
トップ側とボトム側の振分長が均等かつ平行になるときの回転角$\theta'$は、\pageeqref{eq:saifuriwakeangle}より、
\begin{align*}
...
\index{みぞちゅうしん@溝中心}溝の中心は\index{トップがいさくちゅうしん@外削中心}トップ側の外削中心とする。
...
\paragraph*{外削のない場合}\noindent
\index{みぞちゅうしん@溝中心}溝中心の位置の$X$座標は\pageeqref{eq:mizocenterA}より、
\begin{align*}
  \sqrt{R_\mathrm o^2-\left(f_\mathrm T-\kappa_p-\frac{\kappa_w}2\right)^{\!2}}-\kappa_d-\frac{W_{mx}}2
  -\varDelta\ .
\end{align*}
またA側外面の実測値を$G_{mx}$とすると、\pageeqref{eq:mizocenterAd}より、
\begin{align*}
...
\paragraph*{外削のある場合}\noindent
トップ外削$X$中心を$\mathcal G_{\mathrm Tx}$とすると、\index{みぞちゅうしん@溝中心}溝中心の位置の$X$座標は\pageeqref{eq:mizocenterAG}より、
\begin{align*}
