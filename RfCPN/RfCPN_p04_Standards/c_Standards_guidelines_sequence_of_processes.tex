...
\modHeadchapter{マシニングセンタにおける工程の順番}
...
%% footnote %%%%%%%%%%%%%%%%%%%%%
\footnote{\TopOutcut・\TopCurvedOutcutMilling・\EndFaceBoring・\IncutBoring のいずれか2つが同時に存在する\index{めいさい（モールド）@明細（モールド）}明細はないものと仮定している。}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item \KeywayMilling
