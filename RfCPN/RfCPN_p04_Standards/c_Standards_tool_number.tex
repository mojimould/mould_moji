...
46-48 & （不使用）\\
49, 50 & \index{こうぐ（そくてい）@工具（測定）}測定用の工具（\TouchSensorProbe）\\
...
%\ttfamily T36 & 10.0in\DimpleMilling 用\AngleHead\\
%\ttfamily T41 & 15.5in\ReliefGrooveMilling 用\AngleHead\\
...
& \href{https://www.renishaw.com/shop/Default/Home/Styli/Extensions}{A-5555}-2982（特注）& \index{ルビーきゅう@ルビー球}ルビー球 カーボン軸 & \linkRenishaw\\
 &
