...
\item
The document was typeset using \linkEuler, \linkAMSFonts, \linkLatinModern, \linkHaranoAji, \linkArvo, \linkRoboto, \linkSourceSansPro, \linkTrajanPro, \linkURWArial, \linkURWClassico, \linkNimbusSans, \linkSegoeUI, \linkTestSohne, \linkStereoGothic, \linkYuGothic, \linkConsolas{} and \linkHuiFont{} font families.
\item
