  ...
  \DeclareNewLayer[
    ...
    contents={%
      \begin{tikzpicture}[remember picture, overlay]
        \node[rotate=#2, scale=#3, anchor=center, opacity=#4, text=lightgray, align=center] at (current page.center) {\Huge\scshape#1\\[-8.75pt]\tiny\customtoday};%
      \end{tikzpicture}%
    }%
  ]{WatermarkLayer}
}
\AddLayersToPageStyle{@everystyle@}{WatermarkLayer}
\newcommand{\watermarkCopy}{\setallpageWatermark{\hspace{2.25pt}\textls[-46]{Copy}}{atan(297/210)+5.3}{13.4}{0.275}}
\newcommand{\watermarkDraft}{\setallpageWatermark{Draft}{atan(297/210)+5.1}{25.3}}

\renewcommand{\thepage}{%
  \ifnum\value{page}<100\relax%
    \ifnum\value{page}<10\relax 00\else 0\fi%
  \fi%
  \arabic{page}%
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
