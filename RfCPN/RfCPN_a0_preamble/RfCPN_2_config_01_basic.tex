...
\DeclareNewTOC[owner=\jobname, name=Code]{locode}
\DeclareNewTOC[owner=\jobname, name=Column]{loColumn}
...
%\counterwithin{locode}{section}
\DeclareCaptionLabelFormat{customlabelformat}{#1\thesection.#2}
\captionsetup[figure]{%
  width=.9\textwidth,
  format=hang,
  labelfont={bf, sf},
