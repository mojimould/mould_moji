...
%%%%% HEYPERSETUP %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\TheDocTitleFirst}{加工システムの作成}
\newcommand{\TheDocTitleSecond}{加工プログラム自動生成システムの作成}
\newcommand{\TheDocTitleThird}{統計的管理システムの作成}
\newcommand{\TheDocTitle}{%
\begin{align*}
&\textgt{・\TheDocTitleFirst}\\[16pt]
&\textgt{・\TheDocTitleSecond}%\\[16pt]
&%\textgt{・\TheDocTitleThird}%
\end{align*}%
}
%\newcommand{\TheDocSubject}{}
\newcommand{\TheDocAuthor}{Kurahashi Nobuaki}
\hypersetup{
...
\newtcbinputlisting{\GcodeInputminted}[2][{./RfCPN_a1_includefiles/g_code.py:GCodeLexer}]{
