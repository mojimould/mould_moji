...
\modHeadchapter[lot]{\CreatedNCPrg の内容}
...
ただし、ここでは例として挙げており、\pageautoref{subsec:notopenwork}に伴い、\index{プログラムばんごう@プログラム番号}プログラム番号は\pageautoref{chap:NCprgNumber}の規則には則っていない。
\end{marker}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{multicollongtblr}{\CreatedNCPrg 一覧：\index{メインプログラムのれい@メインプログラムの例}メインプログラムの例1}{ccX[l]}
...
\clearpage
\begin{multicollongtblr}{\CreatedNCPrg 一覧：\index{メインプログラムのれい@メインプログラムの例}メインプログラムの例2}{ccX[l]}
{\ttfamily O}番号 & \SetCell{c}工程 & 使用subprg\\
\SetCell[r=9]{c}
...
\begin{multicollongtblr}{\CreatedNCPrg 一覧：\index{メインプログラムのれい@メインプログラムの例}メインプログラムの例3}{ccX[l]}
{\ttfamily O}番号 & \SetCell{c}工程 & 使用subprg\\
\SetCell[r=4]{c}
...
\paragraph*{目的}
\EndFace 部における外側中心$X$ および $X$方向の外側径の測定、ならびに\KeywayCenter$X$の計算
...
\paragraph*{目的}
\EndFace 部または\KeywayCenter 部における外側中心$Y$ および $Y$方向の外側径の測定
...
\paragraph*{目的}
\EndFace 部における内側中心$X$ および $X$方向の内側径の測定
...
\paragraph*{目的}
\EndFace 部における内側中心$Y$ および $Y$方向の内側径の測定
...
\paragraph*{目的}
$X$方向および$Y$方向の\CenterlineEndFaceDif の測定
...
{\ttfamily V} & {\ttfamily\ttNum22} & \DimpleBallendRadius\\
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KEndFaceRight ：加工 \EndFacecut{} コーナーR 左回り}
...
引数 & 変数 & 内容\\
{\ttfamily R} & {\ttfamily\ttNum18} & \ODCornerR\\
{\ttfamily Z} & {\ttfamily\ttNum26} & \ReAlocationLength\\
\end{multicollongtblr}
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KOutcutRLeft ：加工 \Outcut{} コーナーR 左回り}
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KCurvedOutcutRLeft ：加工 \CurvedOutcut{} コーナーR 左回り}
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KKeywayConerLeft ：加工 \Keyway{} 左回り}
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KEndFaceOutCChamferRLeft ：加工 \EndFaceOutCChamfer{} コーナーR 左回り}
...
%% section 46.15 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KEndFaceCurvedOutCChamferRLeft ：加工 \CurvedOutcut 用\EndFaceOutCChamfer{} コーナーR 左回り}

\paragraph*{目的}
左回り\CurvedOutcut 用\EndFaceOutChamferMilling における位置設定
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KEndFaceInCChamferRLeft ：加工 \EndFaceInCChamfer{} コーナーR 左回り}
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KEndFaceBoring ：加工 \EndFaceBoring{} コーナーR 左回り}
...
%% section 46.2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\KIncutBoring ：加工 \IncutBoring{} コーナーR 左回り}
