...
\tPart[lot]{解析計算に基づく数値解析\label{part:NC}}{%
\paragraph*{\tpartgoal}
...
%% chapters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{./RfCPN_p06_Numerical_Calculation/c_RfCPN_parameter_information_necessary}
\input{./RfCPN_p06_Numerical_Calculation/c_RfCPN_conditional_branching_information_necessary}
\input{./RfCPN_p06_Numerical_Calculation/c_RfCPN_NC_for_mainprg}
\input{./RfCPN_p06_Numerical_Calculation/c_RfCPN_NC_for_subprg}
