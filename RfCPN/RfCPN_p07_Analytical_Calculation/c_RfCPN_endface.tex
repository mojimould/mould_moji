...
ただし機内の\index{モールド}モールドは、考えている側の\EndFace が工具側に向いているものとする。
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{スペーサ}スペーサを用いた場合のT\texorpdfstring{$_{R_\mathrm c}'$}{Rc'}}
\index{スペーサ}スペーサを取付けた後の\TopCurvatureCenter の位置T$_{R_\mathrm c}'$と、\TableCenter Pとの$X$方向の差は、
\begin{align*}
  \left(
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{テーブル}テーブルを傾けた場合のT\texorpdfstring{$_{R_\mathrm c}'$}{Rc'}}
\index{テーブル}テーブルを傾けた後の\TopCurvatureCenter の位置T$_{R_\mathrm c}'$と、\TableCenter Pとの$X$方向の差は、
\begin{align*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{スペーサ}スペーサを用いた場合のT\texorpdfstring{$_\mathrm c'$}{c'}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{テーブル}テーブルを傾けた場合のT\texorpdfstring{$_\mathrm c'$}{c'}}
同様にして、外面A・C側のトップ端点T$_\mathrm o'$, T$_\mathrm i'$の、\TableCenter Pを原点とした場合の$X$座標はそれぞれ、
\begin{align}
%% label{eq:tableTi}
  \label{eq:tableTi}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{スペーサ}スペーサを用いた場合のB\texorpdfstring{$_{R_\mathrm c}'$}{Rc'}}
\index{スペーサ}スペーサ取付後の\BottomCurvatureCenter B$_{R_\mathrm c}'$と、\TableCenter Pとの$X$方向の差は、トップ側の場合と同様に考えて
%% footnote %%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{テーブル}テーブルを傾けた場合のB\texorpdfstring{$_{R_\mathrm c}'$}{Rc'}}
\index{テーブル}テーブルを傾けた後の\BottomCurvatureCenter の位置B$_{R_\mathrm c}'$と、\TableCenter Pとの$X$方向の差は、トップ側の場合と同様に考えて
\begin{align*}
  %\label{eq:tableBRc}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{スペーサ}スペーサを用いた場合のB\texorpdfstring{$_\mathrm c'$}{c'}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\index{テーブル}テーブルを傾けた場合のB\texorpdfstring{$_\mathrm c'$}{c'}}
外面A・C面側のボトム端点B$_{R_\mathrm o}'$, B$_{R_\mathrm i}'$の、\TableCenter Pを原点とした場合の$X$座標はそれぞれ、
\begin{align}
  \label{eq:tableBRi}
  \text{C側端点：}&~~
...
%% section 22.3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\EndFacecutMilling の\index{こうぐけいほせい@工具径補正}工具径補正}
...
%% subsection 20.3.1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\index{こうぐけいほせい@工具径補正}工具径補正を用いる場合}
\index{こうぐけいほせい@工具径補正}工具径補正{\ttfamily G42}を用いる場合を考える。
