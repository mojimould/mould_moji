...
\modHeadchapter[loC]{端面削（外径）の幾何}
ここでは主に、\index{ワーク}ワークの\index{たんめんさく@端面削}\textbf{端面削}に関する測定・加工に必要な\expandafterindex{きかてきせいしつ（たんめんさく）@幾何的性質（端面削）}幾何的性質を考える。
...
%% section 22.3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{端面削加工の工具径補正}
端面削加工として、$X+$, $Y+$方向の角から始めて
%% footnote %%%%%%%%%%%%%%%%%%%%%
