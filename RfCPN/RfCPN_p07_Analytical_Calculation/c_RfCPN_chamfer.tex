...
\begin{align*}
  ...
  = 0\ .
\end{align*}
B面側の辺における2測定点をそれぞれ$\mathcal B_\mathrm a$, $\mathcal B_\mathrm b$とし、その座標をそれぞれ($\nicefrac{W_x}4$, $y_{\mathcal B_\mathrm a}$), ($-\nicefrac{W_x}4$, $y_{\mathcal B_\mathrm b}$)とすると、この2点を結んだ直線は以下で与えられる。
\begin{align*}
  \frac{W_x}2\left(y-y_{\mathcal B_\mathrm b}\right)
  -\left(y_{\mathcal B_\mathrm a}-y_{\mathcal B_\mathrm b}\right)\left(x-\frac{W_x}4\right)
  = 0\ .
\end{align*}
同様に、D面側の辺における2測定点をそれぞれ$\mathcal D_\mathrm a$, $\mathcal D_\mathrm b$とし、その座標をそれぞれ($\nicefrac{W_x}4$, $y_{\mathcal D_\mathrm a}$), ($-\nicefrac{W_x}4$, $y_{\mathcal D_\mathrm b}$)とすると、この2点を結んだ直線は以下で与えられる。
\begin{align*}
  \frac{W_x}2\left(y-y_{\mathcal D_\mathrm b}\right)
  -\left(y_{\mathcal D_\mathrm a}-y_{\mathcal D_\mathrm b}\right)\left(x-\frac{W_x}4\right)
  = 0\ .
\end{align*}
