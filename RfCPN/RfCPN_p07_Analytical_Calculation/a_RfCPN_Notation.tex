...
$\kappa_d$ & （\index{ずめん@図面}図面上の）\AsideKeywayDepth & ○\\
...
$u, v$ & \index{パラメータ（パラメトリックサーフェス）}パラメトリックサーフェスのパラメータ &\\
$C(t)$ & \index{アイソパラメトリックきょくせん@アイソパラメトリック曲線}アイソパラメトリック曲線 &\\
$f_i$ & \index{きていかんすう（アイソパラメトリックきょくせん）@きていかんすう（アイソパラメトリック曲線）}アイソパラメトリック曲線の基底関数 &\\
$P_i$ & \index{せいぎょてん（アイソパラメトリックきょくせん）@制御点（アイソパラメトリック曲線）}アイソパラメトリック曲線の制御点 &\\
$N_{i, p}$ & \index{きていかんすう（B-スプラインきょくせん）@きていかんすう（B-スプライン曲線）}B-スプライン曲線の基底関数 &\\
