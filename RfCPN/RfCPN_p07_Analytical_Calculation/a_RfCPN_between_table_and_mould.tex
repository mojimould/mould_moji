...
ここで\index{モールド}を描画する際、\index{モールドのちゅうしん@モールドの中心}モールドの中心
%% footnote %%%%%%%%%%%%%%%%%%%%%
...
\end{align*}
だけ実軸方向に離れていることがわかる。
\pageeqref{eq:tableCenter}より、これは\TableCenter Pとワークの\CenterCurvature$R_\mathrm c$との差であることがわかる。
...
\index{スペーサあつ@スペーサ厚}厚さ$\delta_s\,(>0)$のスペーサを取付けた場合、ワークの受板と接する点と\TableCenter Pとは、実軸方向に
\begin{align*}
...
\end{align*}
だけ実軸方向に離れていることがわかる。
\pageeqref{eq:tableCenter}および\pageeqref{eq:spacerMoveHdistance}より、これはスペーサ取付け後のモールド中心とモールドの\CenterCurvature$R_\mathrm c$との差であることがわかる。
