...
\end{align*}
まとめると、求める\SpacerThickness$\delta_\mathrm s$は、
\begin{align*}
  \delta_\mathrm s
  = 2l\cdot
    \frac{\displaystyle
...
%% section 21.3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\index{テーブル}テーブルの回転による\AlocationLength の調節}
これまで\TopAlocationLength・\BottomAlocationLength の差を小さくするために\index{スペーサ}スペーサを用いる手法を考えてきた。
\index{スペーサ}スペーサを取付けることは、本質的にはボトム側の\index{うけいた@受板}受板の点U$_\mathrm B$を中心に回転しているということである。
このとき回転の中心はU$_\mathrm B$である必要はなく、他の点でも問題ない。
したがって、\index{スペーサ}スペーサを用いて回転をしなくても、\index{テーブル}テーブルそのものを回転するという手法が考えられる。
これは回転の中心が、\index{うけいたのちゅうしん@受板の中心}受板の中心U$_\mathrm B$から\textbf{\TableCenter}Pに変わることに相当する。

\index{うけいたのちゅうしん@受板の中心}受板の中心U$_\mathrm B$と、\TableCenter Pとの実軸方向の距離を$\Delta$とすると、\TableCenter Pの$X$座標$\Delta'$は次で与えられる。
...
トップ側の\AlocationLength が$f_\mathrm T'$となる回転角$\theta$は、\pageeqref{eq:saiallocationT}より、
\begin{align*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{hosoku}
改めてまとめると、\index{テーブル}テーブルを$-\theta$だけ傾けた後の\TopReAlocationLength$f_\mathrm T'$は、
\begin{align*}
