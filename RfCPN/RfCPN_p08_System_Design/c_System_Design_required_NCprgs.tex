...
\begin{enumerate}[label*=\sarrow]
\item \index{ワークざひょうけい@ワーク座標系}ワーク座標系は、トップ端内側中心に該当するものを使用
...
\begin{enumerate}[label*=\sarrow]
\item A面またはC面における、任意の\Dimple に対する深さ方向表面位置の測定
\item A面またはC面における、任意の\Dimple の加工
\end{enumerate}
...
\begin{enumerate}[label*=\sarrow]
\item A面またはC面における、任意の\Dimple に対する深さ方向表面位置座標
\end{enumerate}
...
\begin{enumerate}[label*=\sarrow]
\item B面またはD面における、任意の\Dimple に対する深さ方向表面位置の測定
\item B面またはD面における、任意の\Dimple の加工
\end{enumerate}
...
\begin{enumerate}[label*=\sarrow]
\item B面またはD面における、任意の\Dimple に対する深さ方向表面位置座標
\end{enumerate}
