...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MXOThickness：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MYOThickness：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MXOface：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
\item \KeywayPos 補正値
\item \KeywayWidth 補正値
\item 工具 - \EndFace 間 $Z$方向クリアランス平面間距離
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MXIWidth：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MYIWidth：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%% subsection 36.06.05 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\MYIWidth：\index{ひんしつほしょう@品質保証}品質保証}
\begin{enumerate}[label*=\sarrow]
\item 使用可能な\index{ワークざひょうけい@ワーク座標系}ワーク座標系の範囲を限定
\item \index{ひきすう@引数}引数の設定可能範囲を限定
\item 関連コモン変数の設定可能範囲を限定
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MXIface：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
\item トップ外$X$芯出し 測定位置$Z$補正値
\item ボトム外$X$芯出し 測定位置$Z$補正値
\item 工具 - \EndFace 間 $Z$方向クリアランス平面間距離
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\MCenterline：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
\item 工具 - \EndFace 間 $Z$方向クリアランス平面間距離
\item \TouchSensorProbe 測定時の近付き量
\item \TouchSensorProbe 測定時の行過ぎ量
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\KEndFaceRight：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\KOutcutRLeft：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\KCurvedOutcutRLeft：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%% subsection 36.16.05 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\KCurvedOutcutRLeft：\index{ひんしつほしょう@品質保証}品質保証}
\begin{enumerate}[label*=\sarrow]
\item \index{ひきすう@引数}引数の設定可能範囲を限定
\item 関連コモン変数の設定可能範囲を限定
\end{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{\KKeywayConerLeft：必要な主な\index{へんすう@変数}変数}
\begin{enumerate}[label*=\sarrow]
...
%% subsection 36.17.05 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\KKeywayConerLeft：\index{ひんしつほしょう@品質保証}品質保証}
\begin{enumerate}[label*=\sarrow]
\item \index{ひきすう@引数}引数の設定可能範囲を限定
\item 関連コモン変数の設定可能範囲を限定
\end{enumerate}
