...
\begin{multicollongtblr}[white]{\ttNum725\,-\ttNum739：\Dimple~移動 \DLtwoAC\DLtwoBD 用}{cX[l]}
変数 & 内容\\
\ttNum725 & プログラム読込時ブロックエンド$Y$ or $X$ (\ttNum5002, \ttNum5001)\\
\ttNum726 & プログラム読込時ブロックエンド$Z$ (\ttNum5003)\\
\ttNum727 & \Dimple~偶数列の列数\\
\ttNum728 & \Dimple~偶数列（一列）の\DimpleNum$d_\mathrm e$\\
\ttNum729 & \Dimple~奇数列（一列）の\DimpleNum$d_\mathrm o$\\
...
%\clearpage
\begin{multicollongtblr}[white]{\ttNum740\,-\ttNum749：\Dimple~測定~\DMLthreeAC\DMLthreeBD 用}{cX[l]}
変数 & 内容\\
\SetRow{unusingVariables}
\ttNum740 & （予備）\\
\SetRow{unusingVariables}
