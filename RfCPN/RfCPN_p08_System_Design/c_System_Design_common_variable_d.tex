...
%% subsection 39.05.03 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\ttNum650\,-\ttNum699：工具の\index{おくりはやさ@送り速さ}送り速さ}
\ttNum650\,-\ttNum699については、工具の\index{おくりはやさ@送り速さ}送り速さに関するものとする。\\

\begin{multicollongtblr}[white]{\ttNum650\,-\ttNum674：測定用工具の\index{おくりはやさ@送り速さ}送り速さ\TBW}{cX[l]c}
変数 & 内容 & 設定例\\
...
\clearpage
\begin{multicollongtblr}[white]{\ttNum675\,-\ttNum699：加工用工具の\index{おくりはやさ@送り速さ}送り速さ\TBW}{cX[l]c}
変数 & 内容 & 設定例\\
\ttNum675 & \EndFacecutMilling：直線 & \EndFaceLinearFeedRate\\
\ttNum676 & \EndFacecutMilling：コーナー & \EndFaceCornerFeedRate\\
\ttNum677 & \OutcutMilling：直線 & \OutcutLinearFeedRate\\
\ttNum678 & \OutcutMilling：コーナー & \OutcutCornerFeedRate\\
\ttNum679 & \KeywayMilling：直線 & \KeywayLinearFeedRate\\
\ttNum680 & \KeywayMilling：コーナー & \KeywayCornerFeedRate\\
\ttNum681 & \EndFaceOutCChamferMilling：直線 & \OutCChamferLinearFeedRate\\
\ttNum682 & \EndFaceOutCChamferMilling：コーナー & \OutCChamferCornerFeedRate\\
\ttNum683 & \EndFaceInCChamferMilling：直線 & \InCChamferLinearFeedRate\\
\ttNum684 & \EndFaceInCChamferMilling：コーナー & \InCChamferCornerFeedRate\\
\ttNum685 & \EndFaceBoringMilling：直線 & \EndFaceBoringLinearFeedRate\\
\ttNum686 & \EndFaceBoringMilling：コーナー & \EndFaceBoringCornerFeedRate\\
\ttNum687 & \IncutBoringMilling：直線 & \IncutBoringLinearFeedRate\\
\ttNum688 & \IncutBoringMilling：コーナー & \IncutBoringCornerFeedRate\\
\ttNum689 & \DimpleMilling：\index{ひょうめんアプローチ@表面アプローチ}表面アプローチ & \DimpleApproachFeedRate\\
\ttNum690 & \DimpleMilling：\TSlotCutter{} 加工 & \DimpleTSlotProcessFeedRate\\
\ttNum691 & \DimpleMilling：\BallEndMill{} 加工（深さ方向） & \DimpleBallendProcessFeedRate\\
\ttNum692 & \DimpleMilling：\BallEndMill{} 加工（回転方向） & \DimpleBallendRotateProcessFeedRate\\
\SetRow{unusingVariables}
\ttNum693 & （予備） & \\
\SetRow{unusingVariables}
\ttNum694 & （予備） & \\
...
%% subsection 39.05.04 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\ttNum700\,-\ttNum724：\index{スピンドル}スピンドルの\index{しゅじくかいてんすう@主軸回転数}回転数（切削時）}
\ttNum700\,-\ttNum724については、切削時の工具の\index{しゅじくかいてんすう@主軸回転数}主軸回転数に関するものとする。\\

\begin{multicollongtblr}[white]{\ttNum700\,-\ttNum724：\index{しゅじくかいてんすう@主軸回転数}主軸回転数（切削時）}{cX[l]c}
変数 & 内容 & 設定例\\
\ttNum700 & \EndFacecutMilling & \EndFaceSpindleSpeed\\
\ttNum701 & \OutcutMilling & \OutcutSpindleSpeed\\
\ttNum702 & \KeywayMilling & \KeywaySpindleSpeed\\
\ttNum703 & \EndFaceOutCChamferMilling & \OutCChamferSpindleSpeed\\
\ttNum704 & \EndFaceInCChamferMilling & \InCChamferSpindleSpeed\\
\ttNum705 & \EndFaceBoringMilling & \EndFaceBoringSpindleSpeed\\
\ttNum706 & \IncutBoringMilling & \IncutBoringSpindleSpeed\\
\ttNum707 & \DimpleMilling（\TSlotCutter） & \DimpleTSlotSpindleSpeed\\
\ttNum708 & \DimpleMilling（\BallEndMill） & \DimpleBallendSpindleSpeed\\
\SetRow{unusingVariables}
\ttNum709 & （予備） & \\
\SetRow{unusingVariables}
\ttNum710 & （予備） & \\
...
%\clearpage
\begin{multicollongtblr}[white]{\ttNum900045\,-\ttNum900048：\TopEndFace レベル出し 測定用 \MEndFaceBothSideZ}{cX[l]}
変数 & 内容\\
...
\SetRow{unusingVariables}
\ttNum901030 & （予備） &\\
\ttNum901031 & \OuterDiameter 修正用パラメタ & 100.0\\
\SetRow{unusingVariables}
\ttNum901032 & （予備） &\\
\SetRow{unusingVariables}
\ttNum901033 & （予備） &\\
