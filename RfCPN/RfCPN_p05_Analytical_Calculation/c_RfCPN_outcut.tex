...
%% subsection 19.04.03 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\CurvedOutcutCornerR の加工\TBW}
...
たとえば\BottomCurvedOutcut のBCコーナーRに注目したとき、これを始点から終点まで円弧方向に$n-1$個の区間に等分割する。
このとき各々の点の$X$座標は、$j = 1, 2, \cdots, n$として
\begin{align*}
  1,~\cos\frac1n\cdot\frac\pi2,~\cos\frac2n\cdot\frac\pi2,~\cdots,~\cos\frac{j-1}n\cdot\frac\pi2,~\cdots,~\cos\frac{n-1}n\cdot\frac\pi2,~0
\end{align*}
となるため、各区間の$X$方向に進む距離は
\begin{align*}
  \cos\frac{j-1}n\cdot\frac\pi2-\cos\frac jn\cdot\frac\pi2\ .
\end{align*}
したがって、それぞれの区間に対して
\begin{align*}
  \frac1n\frac1{\displaystyle\cos\frac{j-1}n\cdot\frac\pi2-\cos\frac jn\cdot\frac\pi2}
\end{align*}
をかければよい。
