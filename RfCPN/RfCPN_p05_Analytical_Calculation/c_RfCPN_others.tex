...
\modHeadchapter[loColumn]{その他の幾何}
...
\FixtureBolt には\index{パッドつきボルト@パッド付きボルト}パッド付きのボルトが用いられる。
...
使用している\FixtureBolt は\index{スイベルパッド}スイベルパッド\href{https://www.nabeya.co.jp/pdf/9461.pdf}{SVP0820}であり、$l_p = 15.3$[mm]である。
...
%% section 28.05 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\OuterDiameter の統一化に伴う幾何}
機械加工前の修正等により、トップ端・ボトム端部の\OuterDiameter が\index{こうさ@公差}公差から（+側に）外れることがある。
...
$f_\mathrm T'-z$の位置に対する傾き角度は、\pageeqref{eq:realocationT}より、
\begin{align*}
...
%% section 28.06 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\Tilt の幾何}
\ACTilt を測定する方法として、材料のC面側の2点を測定し、その水平方向の差をみる方法を取り上げる。
測定点を\TopEndFace から距離$t_\mathrm T$, および\BottomEndFace から距離$t_\mathrm B$の2点とすると、測定するC側外面の位置は\pageeqref{eq:tableTi}, \pageeqref{eq:tableBRi}より、
\begin{align*}
  \text{トップ側：}~~
  & \ab[
    \begin{array}{c}
