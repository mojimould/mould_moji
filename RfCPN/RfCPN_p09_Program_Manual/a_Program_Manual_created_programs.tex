...
\modHeadchapter[lot,lol]{作成したNCプログラム\label{chap:createdNCprgDM}\vphantom{\ref{chap:createdNCprgDM}}}
...
%% Prg. \KUchiMentoriRLeft %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KEndFaceBoring\,:加工 \EndFaceBoring{} コーナーR 左回り1周}
\inputminted{"g_code.py:GCodeLexer -x"}{../Created_NC_Programs/sub_programs/\nameKUchiMentoriRLeft.nc}
...
%% Prg. \KOLeftFF %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KOLeftFF\,:外側 {\ttfamily G41} 左回り1周 右始まり}
\inputminted{"g_code.py:GCodeLexer -x"}{../Created_NC_Programs/sub_programs/\nameKOLeftFF.nc}
...
%% Prg. \KOLeftFS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KOLeftFS\,:外側 {\ttfamily G42} 左回り1周 右上始まり}
\inputminted{"g_code.py:GCodeLexer -x"}{../Created_NC_Programs/sub_programs/\nameKOLeftFS.nc}
...
%% Prg. \KILeftFF %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modcaptionof{lstlisting}{\KILeftFF\,:内側 {\ttfamily G41} 左回り1周 中央上始まり}
\inputminted{"g_code.py:GCodeLexer -x"}{../Created_NC_Programs/sub_programs/\nameKILeftFF.nc}
