...
%% section 24.02 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\modHeadsection{\DMC・\MMC における工程の順番\label{sec:MillingSystemFlow}}
...
%% footnote %%%%%%%%%%%%%%%%%%%%%
\footnote{\TopOutcut・\TopCurvedOutcutMilling・\EndFaceBoring・\IncutBoring が同時に存在する\index{めいさい@明細}明細はないものと仮定している。}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item \KeywayMilling
