...
A, B, Cにはそれぞれ\ttNum01, \ttNum02, \ttNum03が割り当てられ、I, J, Kは入力の順序でマクロの\ttNum04から順番に\ttNum33まで割り当てられる
%% footnote %%%%%%%%%%%%%%%%%%%%%
\footnote{たとえば、Kの後にIを用いた場合でも、K: {\ttfamily\ttNum04}, I: {\ttfamily\ttNum07}のようになることに注意。
これは引数指定Iでも同様である。}。
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
