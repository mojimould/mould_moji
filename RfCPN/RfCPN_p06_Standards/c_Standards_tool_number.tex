...
番号 & 内容\\
01 & （空）\\
02-05 & \index{たんめんさくかこう@端面削加工}端面削加工用の工具\\
06-10 & \expandafterindex{\yomiKeyway かこう@\nameKeyway 加工}\nameKeyway 加工用の工具\\
11-15 & \expandafterindex{\yomiEndFaceChamfer かこう@\nameEndFaceChamfer 加工}\nameEndFaceChamfer 加工用の工具\\
...
\ttfamily T\ttNum & 工具\\
\ttfamily T01 & 空\\
\ttfamily T02 & $\phi100$\index{たんめんさくかこうようフェイスミル@端面削加工用フェイスミル}端面削加工用フェイスミル\\
...
\ttfamily T11 & $\phi4.0\times 15^\circ$\expandafterindex{\yomiEndFaceChamfer かこうようテーパエンドミル@\nameEndFaceChamfer 加工用テーパエンドミル}\nameEndFaceChamfer 加工用テーパエンドミル\\
\ttfamily T12 & $\phi0.8\times 30^\circ$\expandafterindex{\yomiEndFaceChamfer かこうようテーパエンドミル@\nameEndFaceChamfer 加工用テーパエンドミル}\nameEndFaceChamfer 加工用テーパエンドミル\\
\ttfamily T13 & $\phi2.0\times 45^\circ$\expandafterindex{\yomiEndFaceChamfer かこうようテーパエンドミル@\nameEndFaceChamfer 加工用テーパエンドミル}\nameEndFaceChamfer 加工用テーパエンドミル\\
