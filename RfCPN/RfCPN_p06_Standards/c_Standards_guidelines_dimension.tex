...
\EndFaceOutCChamfer については、\index{さぎょうしゃのふたん@作業者の負担}作業者の安全・環境・品質・\index{さぎょう効率@作業効率}作業効率を考慮して、原則としてマシニングセンタ（\TaperEndMill）を用いて加工を行うものとする。
...
\EndFaceInCChamfer については、\index{さぎょうしゃのふたん@作業者の負担}作業者の安全・環境・品質・\index{さぎょう効率@作業効率}作業効率を考慮して、原則としてマシニングセンタ（\TaperEndMill）を用いて加工を行うものとする。
ただし、やむを得ない場合は、\index{てもちけんまき@手持ち研磨機}手持ち研磨機や\index{やすり}やすりを用いた手動による加工で行ってもよい。
...
\EndFaceInRChamfer については、\index{さぎょうしゃのふたん@作業者の負担}作業者の安全・環境・品質・\index{さぎょう効率@作業効率}作業効率を考慮して、原則としてその一部を\EndFaceInCChamferMilling として行うものとする。
仕上げ加工については\index{やすり}やすり等を用いて手動で行うものとする。
