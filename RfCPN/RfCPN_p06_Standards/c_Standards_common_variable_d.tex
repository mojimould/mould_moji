...
\ttNum187 & \Inlay{} 仕上げ加工 追加回数 (上限3) & 0\\
\SetRow{unusingVariables}
\ttNum188 & （不使用） &\\
...
\SetRow{unusingVariables}
\ttNum482 & （予備） &\\
\ttNum483 & \Inlay$X+$補正 & 0\\
\ttNum484 & \Inlay 径（直径）$+$補正 & 0\\
\ttNum485 & \Inlay{} 仕上げ前 一時停止 (0:{\ttfamily M00}, 1:non-stop, 2:扉前{\ttfamily M00}) & 1\\
\ttNum486 & \Inlay{} 仕上げ後 一時停止 (0:{\ttfamily M00}, 1:non-stop, 2:扉前{\ttfamily M00}) & 1\\
\SetRow{unusingVariables}
\ttNum487 & （予備） &\\
\SetRow{unusingVariables}
\ttNum488 & （予備） &\\
...
\ttNum637 & \InlayMilling1回あたりの削り代 & 2.0\\
\ttNum638 & \InlayMilling{} 仕上げ前 残り削り代 & 1.0\\
\SetRow{unusingVariables}
\ttNum639 & （予備） & \\
\SetRow{unusingVariables}
\ttNum640 & （予備） & \\
...
\ttNum670 & \InlayMilling：直線 & \InlayLinearFeedRate\\
\ttNum671 & \InlayMilling：コーナー & \InlayCornerFeedRate\\
...
\ttNum681 & \InlayMilling & \InlaySpindleSpeed \\
