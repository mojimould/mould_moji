...
\SetRow{unusingVariables}
\ttNum187 & （不使用） &\\
\ttNum188 & ボトム\Outcut{} 仕上げ加工 追加回数 (上限3) & 0\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{marker}
\expandafterindex{\yomiOutcutCenter そくてい@\nameOutcutCenter 中心測定}\nameOutcutCenter 測定\MXIface で\index{たんめんうちめんとり@端面内面取}端面内面取がある場合、測定位置$Z$は端面の$Z$位置でないことに注意
\end{marker}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\ttNum613 & （予備） &\\
\SetRow{unusingVariables}
\ttNum614 & （\EndFaceOutCChamfer 加工用予備） & \\
\SetRow{unusingVariables}
\ttNum615 & （予備） &\\
\SetRow{unusingVariables}
\ttNum616 & （\EndFaceInCChamfer 加工用予備） &\\
\SetRow{unusingVariables}
\ttNum617 & （予備） &\\
\SetRow{unusingVariables}
...
\ttNum631 & \EndFaceOutCChamfer 加工1回あたりの削り代（直径） & 2.000\\
\ttNum632 & \EndFaceOutCChamfer 加工 仕上げ前 残り削り代（直径） & 1.000\\
\ttNum633 & \EndFaceInCChamfer{}加工1回あたりの削り代（直径） & 2.000\\
\ttNum634 & \EndFaceInCChamfer{}加工 仕上げ前 残り削り代（直径） & 1.000\\
\SetRow{unusingVariables}
...
\ttNum664 & \EndFaceOutCChamfer 加工：直線 & \OutCChamferLinearFeedRate\\
\ttNum665 & \EndFaceOutCChamfer 加工：コーナー & \OutCChamferCornerFeedRate\\
\ttNum666 & \EndFaceInCChamfer 加工：直線 & \InCChamferLinearFeedRate\\
\ttNum667 & \EndFaceInCChamfer 加工：コーナー & \InCChamferCornerFeedRate\\
...
\ttNum678 & \EndFaceOutCChamfer 加工 & \OutCChamferSpindleSpeed\\
\ttNum679 & \EndFaceInCChamfer 加工 & \InCChamferSpindleSpeed\\
