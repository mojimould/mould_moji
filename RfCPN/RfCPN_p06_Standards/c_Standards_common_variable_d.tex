...
\ttNum613 & （予備） &\\
\SetRow{unusingVariables}
\ttNum614 & （\EndFaceCChamferMilling 用予備） & \\
\SetRow{unusingVariables}
\ttNum615 & （予備） &\\
\SetRow{unusingVariables}
...
\ttNum632 & \EndFaceOutCChamferMilling{} 仕上げ前 残り削り代（直径） & 1.000\\
\ttNum633 & \EndFaceInCChamferMilling1回あたりの削り代（直径） & 2.000\\
\ttNum634 & \EndFaceInCChamferMilling{} 仕上げ前 残り削り代（直径） & 1.000\\
\SetRow{unusingVariables}
\ttNum635 & （\EndFaceBoringMilling 用予備） & \\
\SetRow{unusingVariables}
\ttNum636 & （\EndFaceBoringMilling 用予備） & \\
\SetRow{unusingVariables}
\ttNum637 & （予備） & \\
\SetRow{unusingVariables}
\ttNum638 & （予備） & \\
