%
O530002 (last update on 20241030)
...
IF[#690EQ#0]GOTO8000
IF[#690LE10]GOTO8000
(if #689 <= 10 or #0, go to N8000)
(if #690 <= 10 or #0, go to N8000)
...
G91 G01 Y[#31*[#621+#29]] F#689
(Y+: #23-#32-#621 or Y-: #23+#32+#621)
(Y+ or Y-: #621+compensation, speed #689)

IF[#4111EQ34]GOTO0009
G91 G01 Y[#31*#21] F#690
G04 X#622 (wait #622s)
GOTO0010

N0009
G17 G91 G01 Z[#22/4] F#692
G17 G91 G01 Y[#31*#21] F#691
G18 G03 I0 K-[#22/4] F#692
G17 G91 G01 Z[#22/4] F#692
G18 G03 I0 K-[#22/2] F#692
G17 G90 G01 Y#33 F#651
G17 G91 G01 Z-[#22/2] F#651
(Y+ or Y-: U, speed #690 or #691)
...
(#621, #622, #623, #651, #689, #690, #691, #692)
