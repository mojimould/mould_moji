...
IF[#33EQ58]GOTO003
GOTO0800
(if work G# is not 54, 56, 58, go to N0800)
...
(if #655 <= 10 or #0, go to N0800)
(if #901011 <= 100 or #0, go to N0800)

N006
#29=#656
IF[#33NE58]GOTO007
(if #33 is not 58, go to N007)
...
IF[[#900006+#901053-#901055]GE[-[#25/2]+#603]]GOTO0802
(Y-: #602+#603)
(Z+: #30+#901050+#600)
...
G91 G01 Y[#602+#603] F#652
G91 G01 Z[#30+#901050+#600] F#650
IF[[#900007-#901053-#901055]LE[[#25/2]-#603]]GOTO0802
(Y+: #602+#603)
(Z+: #30+#901050+#600)
