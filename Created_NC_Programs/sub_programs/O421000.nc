...
IF[#4012EQ54]THEN #900042=[#5261-#901001]*COS[#900039]-#26*SIN[#900039]
IF[#4012EQ54]THEN #900043=[#5261-#901001]*SIN[#900039]+#26*COS[#900039]
GOTO0006
N0005
IF[#4012EQ56]THEN #900040=[#5261-#901005]*COS[#900038]-#26*SIN[#900038]
IF[#4012EQ56]THEN #900041=[#5261-#901005]*SIN[#900038]+#26*COS[#900038]
IF[#4012EQ54]THEN #900042=[#5261-#901005]*COS[#900039]-#26*SIN[#900039]
IF[#4012EQ54]THEN #900043=[#5261-#901005]*SIN[#900039]+#26*COS[#900039]
(#900040: Top center X)
(#900041: Top center Z)
(#900042: Bot center X)
(#900043: Bot center Z)
...
N0015
#100=[#21-#30]*COS[#900038]
IF[#4012EQ54]THEN #100=[#21-#30]*COS[#900039]
#101=#22-#29
...
N0016
M11 (B-axis unclamp)
IF[#4012EQ56]GOTO0017
IF[#4012EQ54]GOTO0018
N0017
...
G90 G00 X[#900040+[#104/2]+#31*3+#33] Y[#105/2] Z[#900041-#32]
GOTO0103
N0102 (for Bot)
G90 G00 X[#900042+[#104/2]+#31*3+#33] Y[#105/2] Z[#900043+#32]

N0103
G42 D#4120
G91 G00 X-[#31/2] S#676
...
N0105 (for Top)
IF[#4012EQ54]GOTO0106
G90 G01 X[#900040+[#104/2]+#33] Y[#105/2] Z[#900041-#32] F#651
G65 P491005 K1.0 B#900038 C#03 R#18 X#104 Y#105 D#31 F#660 E#661 S#676
G90 G40 G00 X[#900040+[#104/2]+#31*3+#33] Z[#900041-#32]
GOTO0017
N0106 (for Bot)
G90 G01 X[#900042+[#104/2]+#33] Y[#105/2] Z[#900049+#32] F#651
G65 P491005 K1.0 B#900039 C#03 R#18 X#104 Y#105 D#31 F#660 E#661 S#676
G90 G40 G00 X[#900042+[#104/2]+#31*3+#33] Z[#900049+#32]
N0017
END1

N0020 (pause)
IF[#4012EQ56]GOTO0021
IF[#438EQ0]GOTO0022
IF[#438EQ2]GOTO0023
GOTO0026
...
N0201 (for top)
IF[#4012EQ54]GOTO0202
G90 G00 X[#900040+[#30/2]+#31*3+#33] Y[#29/2] Z[#900041-#32]
GOTO0203
N0202 (for Bot)
G90 G00 X[#900042+[#30/2]+#31*3+#33] Y[#30/2] Z[#900043+#32]
...
N0205 (for Top)
IF[#4012EQ54]GOTO0206
G90 G01 X[#900040+[#30/2]+#33] Y[#29/2] Z[#900041-#32] F#651
G65 P491005 K1.0 B#900038 C#03 R#18 X#30 Y#29 D#31 F#660 E#661 S#676
G90 G40 G00 X[#900040+[#30/2]+#31*3+#33] Z[#900041-#32]
GOTO0027
N0206 (for Bot)
G90 G01 X[#900042+[#30/2]+#33] Y[#29/2] Z[#900049+#32] F#651
G65 P491005 K1.0 B#900039 C#03 R#18 X#30 Y#29 D#31 F#660 E#661 S#676
G90 G40 G00 X[#900042+[#30/2]+#31*3+#33] Z[#900049+#32]
N0027
END2
...
(Passed arguments)
(#18, #29, #30, #31, #33, #104, #105, #660, #661, #676)
